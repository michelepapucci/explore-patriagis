...
When the trigger occurs, you can either take your [Reaction](rules/variant-rules/reaction-xphb.md) right after the trigger finishes or ignore the trigger.
