...
**Can't Harm the Charmer.** You can't attack the charmer or target the charmer with damaging abilities or [Magical Effect](rules/variant-rules/magical-effect-xphb.md).
...
**No Concentration.** Your [Concentration](rules/conditions.md#Concentration) is broken.
...
**Saving Throws Affected.** You automatically fail Strength and Dexterity [Saving Throw](rules/variant-rules/saving-throw-xphb.md).
...
**Restricted Movement.** Your only movement options are to [Crawling](rules/variant-rules/crawling-xphb.md) or to spend an amount of movement equal to half your [Speed](rules/variant-rules/speed-xphb.md) (round down) to right yourself and thereby end the condition. If your [Speed](rules/variant-rules/speed-xphb.md) is 0, you can't right yourself.
...
**Saving Throws Affected.** You have [Disadvantage](rules/variant-rules/disadvantage-xphb.md) on Dexterity [Saving Throw](rules/variant-rules/saving-throw-xphb.md).
