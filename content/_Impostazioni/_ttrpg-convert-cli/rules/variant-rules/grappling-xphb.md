...
A creature can grapple another creature. Characters typically grapple by using an [Unarmed Strike](rules/variant-rules/unarmed-strike-xphb.md). Many [Monster](rules/variant-rules/monster-xphb.md) have special attacks that allow them to quickly grapple prey. However a grapple is initiated, it follows these rules.
