...
|--------------|----------------|
| Battle Expert | When you take damage from an attack made with an [Unarmed Strike](rules/variant-rules/unarmed-strike-xphb.md) or a weapon, you can take a Reaction to reduce this damage by `dice:1d4\|noform\|avg` (`1d4`). |
| Skills Expert | You gain proficiency in one of the following skills of your choice: [Acrobatics](rules/skills.md#Acrobatics), [Athletics](rules/skills.md#Athletics), [Performance](rules/skills.md#Performance), [Sleight of Hand](rules/skills.md#Sleight%20of%20Hand), or [Stealth](rules/skills.md#Stealth). |
| Tools Expert | You gain proficiency with one tool of your choice. |
| Unarmed Combat Expert | When you hit with your [Unarmed Strike](rules/variant-rules/unarmed-strike-xphb.md) and deal damage, the attack deals an extra `dice:1d4\|noform\|avg` (`1d4`) Bludgeoning damage. |
