...
---
# [Animal Lord; Hunter](compendium/bestiary/celestial/animal-lord-hunter-xmm.md)
...
- "desc": "Wisdom Saving Throw: DC 20, any enemy that starts its turn in a 30-foot\
    ...
    \ originating from the animal lord. Failure: The target has the [Frightened](rules/conditions.md#Frightened)\
...
- "desc": "The animal lord conjures an animal spirit that strikes at a creature and\
    ...
    \ lord has [Advantage](rules/variant-rules/advantage-xphb.md) on attack rolls\
    \ against the target until the start of the animal lord's next turn."
  "name": "Animal Spirit"
"bonus_actions":
