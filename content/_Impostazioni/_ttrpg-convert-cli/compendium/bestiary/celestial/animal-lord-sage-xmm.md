...
---
# [Animal Lord; Sage](compendium/bestiary/celestial/animal-lord-sage-xmm.md)
...
- "desc": "Wisdom Saving Throw: DC 20, any enemy that starts its turn in a 30-foot\
    ...
    \ originating from the animal lord. Failure: The target takes dice:3d6|noform|avg|text(10)\
    \ (3d6) Psychic damage, and the target is magically bewildered until the end\
    \ of its next turn. While bewildered, the target subtracts dice:1d4|noform|avg\
    \ (1d4) from its saving throws."
...
- "desc": "The animal lord conjures an animal spirit that strikes at a creature and\
    ...
    \ + 6) Radiant damage. Success: Half damage. Failure or Success: The target\
