...
- "desc": "Wisdom Saving Throw: DC 20, any enemy that starts its turn in a 30-foot\
    ...
    \ effects:\n\n- Captivated (Forager Only). The target has the [Charmed](rules/conditions.md#Charmed)\
    \ condition until the end of its next turn. While [Charmed](rules/conditions.md#Charmed),\
    \ the target has the [Incapacitated](rules/conditions.md#Incapacitated) condition.\
    \  \n- Fearful (Hunter Only). The target has the [Frightened](rules/conditions.md#Frightened)\
    \ condition until the end of its next turn.  \n- Mired (Sage Only). The target\
    \ takes dice:3d6|noform|avg|text(10) (3d6) Psychic damage, and the target\
    \ is magically bewildered until the end of its next turn. While bewildered, the\
    \ target subtracts dice:1d4|noform|avg (1d4) from its saving throws.  "
  "name": "Lordly Presence"
- "desc": "The animal lord has [Advantage](rules/variant-rules/advantage-xphb.md)\
...
- "desc": "The animal lord makes two attacks, using Rend or Radiant Ray in any combination,\
  ...
  "name": "Multiattack"
- "desc": "Melee Attack: dice:1d20+13|noform|text(+13), reach 5 ft. Hit: dice:2d6+7|noform|avg|text(14)\
    \ (2d6 + 7) Slashing damage plus dice:2d6|noform|avg|text(7) (2d6) Force\
    \ damage."
  "name": "Rend"
- "desc": "Ranged Attack: dice:1d20+12|noform|text(+12), range 120 ft. Hit:\
    \ dice:4d6+6|noform|avg|text(20) (4d6 + 6) Radiant damage."
  "name": "Radiant Ray"
- "desc": "The animal lord conjures an animal spirit that strikes at a creature and\
    ...
    \ can see within 120 feet. Failure: dice:4d10+6|noform|avg|text(28) (4d10\
    \ + 6) Radiant damage. Success: Half damage. Failure or Success: One of the\
    \ following effects occurs:\n\n- Fortify (Forager Only). The animal lord gains\
    \ 20 [Temporary Hit Points](rules/variant-rules/temporary-hit-points-xphb.md).\
    \  \n- Marked as Prey (Hunter Only). The animal lord has [Advantage](rules/variant-rules/advantage-xphb.md)\
    \ on attack rolls against the target until the start of the animal lord's next\
    \ turn.  \n- Pesky Swarm (Sage Only). The target has [Disadvantage](rules/variant-rules/disadvantage-xphb.md)\
...
- "desc": "The animal lord shape-shifts into a Huge or smaller version of the animal\
  ...
  "name": "Shape-Shift"
"legendary_actions":
- "desc": "The animal lord moves up to its [Speed](rules/variant-rules/speed-xphb.md)\
