...
- "desc": "The sphinx casts one of the following spells, requiring no Material components\
    ...
    \ [Dispel Magic](compendium/spells/dispel-magic-xphb.md), [Legend Lore](compendium/spells/legend-lore-xphb.md),\
    \ [Locate Object](compendium/spells/locate-object-xphb.md), [Plane Shift](compendium/spells/plane-shift-xphb.md),\
    \ [Remove Curse](compendium/spells/remove-curse-xphb.md), [Tongues](compendium/spells/tongues-xphb.md)"
  "name": "Spellcasting"
...
- "desc": "The sphinx makes three Claw attacks."
  "name": "Multiattack"
- "desc": "Melee Attack: dice:1d20+8|noform|text(+8), reach 5 ft. Hit: dice:3d6+4|noform|avg|text(14)\
...
- "desc": "Wisdom Saving Throw: DC 16, each enemy in a 300-foot [Emanation [Area\
    ...
    \ from the sphinx. Failure: dice:10d6|noform|avg|text(35) (10d6) Psychic\
