...
- "desc": "The half-dragon makes two Claw attacks."
  "name": "Multiattack"
- "desc": "Melee Attack: dice:1d20+7|noform|text(+7), reach 10 ft. Hit: dice:1d4+4|noform|avg|text(6)\
    \ (1d4 + 4) Slashing damage plus dice:2d6|noform|avg|text(7) (2d6) damage\
    \ of the type chosen for the Draconic Origin trait."
  "name": "Claw"
- "desc": "Dexterity Saving Throw: DC 14, each creature in a 30-foot [Cone [Area\
    \ of Effect]](rules/variant-rules/cone-area-of-effect-xphb.md). Failure: dice:8d6|noform|avg|text(28)\
    \ (8d6) damage of the type chosen for the Draconic Origin trait. Success:\
    \ Half damage."
