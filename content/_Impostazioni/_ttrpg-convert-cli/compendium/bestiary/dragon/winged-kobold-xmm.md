...
"cr": "1/4"
"traits":
- "desc": "The kobold has [Advantage](rules/variant-rules/advantage-xphb.md) on an\
    \ attack roll against a creature if at least one of the kobold's allies is within\
    \ 5 feet of the creature and the ally doesn't have the [Incapacitated](rules/conditions.md#Incapacitated)\
    \ condition."
  "name": "Pack Tactics"
- "desc": "While in sunlight, the kobold has [Disadvantage](rules/variant-rules/disadvantage-xphb.md)\
...
- "desc": "Ranged Attack: dice:1d20+5|noform|text(+5), range 30 ft. Hit: dice:1d6+3|noform|avg|text(6)\
    \ (1d6 + 3) damage of a type chosen by the kobold: Acid, Cold, Fire, Lightning,\
    \ or Poison."
  "name": "Chromatic Spittle"
"source":
- "XMM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/XMM/Winged%20Kobold.webp"
```
^statblock
