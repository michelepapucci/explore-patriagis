...
- "desc": "The dragon makes three Rend attacks."
  "name": "Multiattack"
- "desc": "Melee Attack: dice:1d20+7|noform|text(+7), reach 10 ft. Hit: dice:2d4+4|noform|avg|text(9)\
    \ (2d4 + 4) Slashing damage plus dice:1d4|noform|avg|text(2) (1d4) Cold\
    \ damage."
  "name": "Rend"
- "desc": "Constitution Saving Throw: DC 15, each creature in a 30-foot [Cone [Area\
    \ of Effect]](rules/variant-rules/cone-area-of-effect-xphb.md). Failure: dice:9d8|noform|avg|text(40)\
    \ (9d8) Cold damage. Success: Half damage."
