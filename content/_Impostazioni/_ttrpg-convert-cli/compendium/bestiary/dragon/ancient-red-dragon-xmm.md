...
- "desc": "The dragon casts one of the following spells, requiring no Material components\
    ...
    \ Ray](compendium/spells/scorching-ray-xphb.md) (level 3 version)\n\n1/day each:\
    \ [Fireball](compendium/spells/fireball-xphb.md) (level 6 version), [Scrying](compendium/spells/scrying-xphb.md)"
  "name": "Spellcasting"
...
- "desc": "Melee Attack: dice:1d20+17|noform|text(+17), reach 15 ft. Hit: dice:2d8+10|noform|avg|text(19)\
    \ (2d8 + 10) Slashing damage plus dice:3d6|noform|avg|text(10) (3d6) Fire\
    \ damage."
  "name": "Rend"
- "desc": "Dexterity Saving Throw: DC 24, each creature in a 90-foot [Cone [Area\
    \ of Effect]](rules/variant-rules/cone-area-of-effect-xphb.md). Failure: dice:26d6|noform|avg|text(91)\
