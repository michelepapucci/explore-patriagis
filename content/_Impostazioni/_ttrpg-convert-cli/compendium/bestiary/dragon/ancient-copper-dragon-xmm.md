...
- "desc": "The dragon makes three Rend attacks. It can replace one attack with a use\
    ...
    \ (level 5 version)."
  "name": "Multiattack"
- "desc": "Melee Attack: dice:1d20+15|noform|text(+15), reach 15 ft. Hit: dice:2d10+8|noform|avg|text(19)\
    \ (2d10 + 8) Slashing damage plus dice:2d8|noform|avg|text(9) (2d8) Acid\
    \ damage."
  "name": "Rend"
- "desc": "Dexterity Saving Throw: DC 22, each creature in an 90-foot-long, 10-foot-wide\
    ...
    \ dice:14d8|noform|avg|text(63) (14d8) Acid damage. Success: Half damage."
...
- "desc": "Charisma Saving Throw: DC 21, one creature the dragon can see within\
    \ 120 feet. Failure: dice:9d6|noform|avg|text(31) (9d6) Psychic damage.\
    \ Until the end of its next turn, the target rolls dice:1d8|noform|avg (1d8)\
    \ whenever it makes an ability check or attack roll and subtracts the number rolled\
    \ from the [D20 Test](rules/variant-rules/d20-test-xphb.md). Failure or Success:\
