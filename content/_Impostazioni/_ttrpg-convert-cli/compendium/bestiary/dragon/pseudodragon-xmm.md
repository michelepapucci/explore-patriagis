...
"cr": "1/4"
"traits":
- "desc": "The pseudodragon has [Advantage](rules/variant-rules/advantage-xphb.md)\
...
- "desc": "Constitution Saving Throw: DC 12, one creature the pseudodragon can see\
    \ within 5 feet. Failure: dice:2d4|noform|avg|text(5) (2d4) Poison damage,\
    \ and the target has the [Poisoned](rules/conditions.md#Poisoned) condition for\
    \ 1 hour. Failure by 5 or More: The [Poisoned](rules/conditions.md#Poisoned) target\
    \ also has the [Unconscious](rules/conditions.md#Unconscious) condition until\
    \ it takes damage or a creature within 5 feet of it takes an action to shake it\
    \ awake."
  "name": "Sting"
"source":
- "XMM"
