...
- "desc": "The dragon makes three Rend attacks. It can replace one attack with a use\
    ...
    \ (level 4 version)."
  "name": "Multiattack"
- "desc": "Melee Attack: dice:1d20+11|noform|text(+11), reach 10 ft. Hit: dice:2d10+6|noform|avg|text(17)\
    \ (2d10 + 6) Slashing damage plus dice:1d8|noform|avg|text(4) (1d8) Acid\
    \ damage."
  "name": "Rend"
...
- "desc": "Constitution Saving Throw: DC 18, each creature in a 60-foot [Cone [Area\
    ...
    \ target can't take Reactions; its [Speed](rules/variant-rules/speed-xphb.md)\
    \ is halved; and it can take either an action or a [Bonus Action](rules/variant-rules/bonus-action-xphb.md)\
...
- "desc": "Charisma Saving Throw: DC 17, one creature the dragon can see within\
    \ 90 feet. Failure: dice:7d6|noform|avg|text(24) (7d6) Psychic damage. Until\
    \ the end of its next turn, the target rolls dice:1d6|noform|avg (1d6) whenever\
    \ it makes an ability check or attack roll and subtracts the number rolled from\
    \ the [D20 Test](rules/variant-rules/d20-test-xphb.md). Failure or Success:\
...
- "desc": "- Chatty Critters. Tiny Beasts magically gain the ability to speak\
    ...
    \ the lair and rolls a 1 on a [D20 Test](rules/variant-rules/d20-test-xphb.md),\
    \ it must succeed on a DC 15 Wisdom saving throw or have the [Incapacitated](rules/conditions.md#Incapacitated)\
...
"source":
- "XMM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/XMM/Adult%20Copper%20Dragon.webp"
```
^statblock
