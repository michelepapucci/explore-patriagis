...
- "desc": "The dragon casts one of the following spells, requiring no Material components\
    ...
    \ [Speak with Dead](compendium/spells/speak-with-dead-xphb.md), [Vitriolic Sphere](compendium/spells/vitriolic-sphere-xphb.md)\
    \ (level 5 version)"
  "name": "Spellcasting"
...
- "desc": "The dragon makes three Rend attacks. It can replace one attack with a use\
    ...
    \ (level 4 version)."
  "name": "Multiattack"
- "desc": "Melee Attack: dice:1d20+15|noform|text(+15), reach 15 ft. Hit: dice:2d8+8|noform|avg|text(17)\
    \ (2d8 + 8) Slashing damage plus dice:2d8|noform|avg|text(9) (2d8) Acid\
    \ damage."
  "name": "Rend"
- "desc": "Dexterity Saving Throw: DC 22, each creature in a 90-foot-long, 10-foot-wide\
    ...
    \ dice:15d8|noform|avg|text(67) (15d8) Acid damage. Success: Half damage."
  "name": "Acid Breath (Recharge 5-6)"
"legendary_actions":
- "desc": "Dexterity Saving Throw: DC 21, one creature the dragon can see within\
    \ 120 feet. Failure: dice:6d10|noform|avg|text(33) (6d10) Poison damage,\
...
"source":
- "XMM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/XMM/Ancient%20Black%20Dragon.webp"
```
^statblock
