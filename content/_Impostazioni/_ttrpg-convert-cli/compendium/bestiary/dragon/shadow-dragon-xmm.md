...
- "desc": "While in [Dim Light](rules/variant-rules/dim-light-xphb.md) or [Darkness](rules/variant-rules/darkness-xphb.md),\
    \ the dragon has [Resistance](rules/variant-rules/resistance-xphb.md) to damage\
    \ that isn't Force, Psychic, or Radiant."
  "name": "Living Shadow"
- "desc": "While in sunlight, the dragon has [Disadvantage](rules/variant-rules/disadvantage-xphb.md)\
    \ on ability checks and attack rolls."
  "name": "Sunlight Sensitivity"
"actions":
- "desc": "The dragon makes three Rend attacks."
  "name": "Multiattack"
- "desc": "Melee Attack: dice:1d20+10|noform|text(+10), reach 10 ft. Hit: dice:2d6+5|noform|avg|text(12)\
    \ (2d6 + 5) Slashing damage plus dice:1d6|noform|avg|text(3) (1d6) Necrotic\
    \ damage."
  "name": "Rend"
- "desc": "Dexterity Saving Throw: DC 17, each creature in a 60-foot [Cone [Area\
    \ of Effect]](rules/variant-rules/cone-area-of-effect-xphb.md). Failure: dice:10d6|noform|avg|text(35)\
    \ (10d6) Necrotic damage. Success: Half damage. Failure or Success: A Humanoid\
    \ reduced to 0 [Hit Points](rules/variant-rules/hit-points-xphb.md) by this damage\
    \ dies, and a [Shadow](compendium/bestiary/undead/shadow-xmm.md) rises from the\
    \ corpse. The shadow is under the dragon's control and shares the dragon's [Initiative](rules/variant-rules/initiative-xphb.md)\
...
- "desc": "The dragon uses Shadow Stealth, and one creature of its choice that it\
    \ can see within 10 feet of it takes dice:3d6|noform|avg|text(10) (3d6) Necrotic\
    \ damage. The dragon can't take this action again until the start of its next\
    \ turn."
  "name": "Veil of Shadow"
"regional_effects":
...
- "desc": "- Negative Energy Suffusion. Whenever a creature within 1 mile of the\
    ...
    \ normally create [Bright Light](rules/variant-rules/bright-light-xphb.md) instead\
    \ create [Dim Light](rules/variant-rules/dim-light-xphb.md), and creatures there\
    \ have [Advantage](rules/variant-rules/advantage-xphb.md) on Dexterity ([Stealth](rules/skills.md#Stealth))\
    \ checks.  "
  "name": ""
...
"source":
- "XMM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/XMM/Shadow%20Dragon.webp"
```
^statblock
