...
- "desc": "The dragon makes three Bite attacks. It can replace one attack with a Tail\
    \ attack."
  "name": "Multiattack"
- "desc": "Melee Attack: dice:1d20+13|noform|text(+13), reach 15 ft. Hit: dice:3d10+7|noform|avg|text(23)\
    \ (3d10 + 7) Piercing damage plus dice:2d6|noform|avg|text(7) (2d6) Fire\
    \ damage. Being underwater doesn't grant [Resistance](rules/variant-rules/resistance-xphb.md)\
    \ to this Fire damage."
  "name": "Bite"
- "desc": "Melee Attack: dice:1d20+13|noform|text(+13), reach 15 ft. Hit: dice:2d10+7|noform|avg|text(18)\
    \ (2d10 + 7) Bludgeoning damage. If the target is a Huge or smaller creature,\
...
- "desc": "Constitution Saving Throw: DC 19, each creature in a 60-foot [Cone [Area\
    ...
    \ (16d6) Fire damage. Success: Half damage. Failure or Success: Being underwater\
    \ doesn't grant [Resistance](rules/variant-rules/resistance-xphb.md) to this Fire\
    \ damage."
