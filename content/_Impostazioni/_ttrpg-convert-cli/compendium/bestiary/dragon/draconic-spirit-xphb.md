...
---
# [Draconic Spirit](compendium/bestiary/dragon/draconic-spirit-xphb.md)
...
- "desc": "Dexterity Saving Throw: DC equals your spell save DC, each creature in\
    \ a 30-foot Cone. Failure: dice:2d6|noform|avg (2d6) damage of a type this\
    \ spirit has Resistance to (your choice when you cast the spell). Success: Half\
    \ damage."
  "name": "Breath Weapon"
"source":
- "XPHB"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/XPHB/Draconic%20Spirit.webp"
```
^statblock