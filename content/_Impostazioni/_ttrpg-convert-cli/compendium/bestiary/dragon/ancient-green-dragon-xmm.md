...
- "desc": "Melee Attack: dice:1d20+15|noform|text(+15), reach 15 ft. Hit: dice:2d8+8|noform|avg|text(17)\
    \ (2d8 + 8) Slashing damage plus dice:3d6|noform|avg|text(10) (3d6) Poison\
    \ damage."
  "name": "Rend"
- "desc": "Constitution Saving Throw: DC 22, each creature in a 90-foot [Cone [Area\
    \ of Effect]](rules/variant-rules/cone-area-of-effect-xphb.md). Failure: dice:22d6|noform|avg|text(77)\
    \ (22d6) Poison damage. Success: Half damage."
...
- "desc": "Constitution Saving Throw: DC 21, each creature in a 30-foot-radius [Sphere\
    ...
    \ on a point the dragon can see within 90 feet. Failure: dice:5d6|noform|avg|text(17)\
