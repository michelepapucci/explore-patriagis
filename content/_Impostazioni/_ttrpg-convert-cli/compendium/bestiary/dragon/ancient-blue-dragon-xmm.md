...
- "desc": "The dragon casts one of the following spells, requiring no Material components\
    ...
    \ [Detect Magic](compendium/spells/detect-magic-xphb.md), [Invisibility](compendium/spells/invisibility-xphb.md),\
...
- "desc": "The dragon makes three Rend attacks. It can replace one attack with a use\
    \ of Spellcasting to cast [Shatter](compendium/spells/shatter-xphb.md) (level\
    \ 3 version)."
  "name": "Multiattack"
- "desc": "Melee Attack: dice:1d20+16|noform|text(+16), reach 15 ft. Hit: dice:2d8+9|noform|avg|text(18)\
    \ (2d8 + 9) Slashing damage plus dice:2d10|noform|avg|text(11) (2d10) Lightning\
    \ damage."
  "name": "Rend"
- "desc": "Dexterity Saving Throw: DC 23, each creature in a 120-foot-long, 10-foot-wide\
    ...
    \ dice:16d10|noform|avg|text(88) (16d10) Lightning damage. Success: Half\
    \ damage."
  "name": "Lightning Breath (Recharge 5-6)"
"legendary_actions":
- "desc": "The dragon uses Spellcasting to cast [Invisibility](compendium/spells/invisibility-xphb.md)\
    \ on itself, and it can fly up to half its [Fly Speed](rules/variant-rules/fly-speed-xphb.md).\
...
- "desc": "- Sinkholes. Sinkholes form more frequently in the area within 1 mile\
    ...
    \ allies finishes a [Long Rest](rules/variant-rules/long-rest-xphb.md), roll dice:1d20|noform|avg\
    \ (). On a 1, a sinkhole opens beneath the creature, and the creature must succeed\
    ...
    \ the lair. The area is [Lightly Obscured](rules/variant-rules/lightly-obscured-xphb.md).\
    \  "
  "name": ""
...
"source":
- "XMM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/XMM/Ancient%20Blue%20Dragon.webp"
```
^statblock
