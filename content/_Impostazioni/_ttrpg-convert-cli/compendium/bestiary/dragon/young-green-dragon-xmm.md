...
- "desc": "Melee Attack: dice:1d20+7|noform|text(+7), reach 10 ft. Hit: dice:2d6+4|noform|avg|text(11)\
    \ (2d6 + 4) Slashing damage plus dice:2d6|noform|avg|text(7) (2d6) Poison\
    \ damage."
  "name": "Rend"
- "desc": "Constitution Saving Throw: DC 14, each creature in a 30-foot [Cone [Area\
    \ of Effect]](rules/variant-rules/cone-area-of-effect-xphb.md). Failure: dice:12d6|noform|avg|text(42)\
    \ (12d6) Poison damage. Success: Half damage."
