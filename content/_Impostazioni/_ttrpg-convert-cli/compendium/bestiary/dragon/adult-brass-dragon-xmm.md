...
- "desc": "Melee Attack: dice:1d20+11|noform|text(+11), reach 10 ft. Hit: dice:2d10+6|noform|avg|text(17)\
    \ (2d10 + 6) Slashing damage plus dice:1d8|noform|avg|text(4) (1d8) Fire\
    \ damage."
  "name": "Rend"
- "desc": "Dexterity Saving Throw: DC 18, each creature in a 60-foot-long, 5-foot-wide\
    ...
    \ dice:10d8|noform|avg|text(45) (10d8) Fire damage. Success: Half damage."
...
- "desc": "Dexterity Saving Throw: DC 16, one creature the dragon can see within\
    \ 120 feet. Failure: dice:6d8|noform|avg|text(27) (6d8) Fire damage, and\
...
"source":
- "XMM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/XMM/Adult%20Brass%20Dragon.webp"
```
^statblock
