...
- "desc": "The dragon makes two Rend attacks."
  "name": "Multiattack"
- "desc": "Melee Attack: dice:1d20+5|noform|text(+5), reach 10 ft. Hit: dice:1d8+3|noform|avg|text(7)\
    \ (1d8 + 3) Slashing damage plus dice:1d6|noform|avg|text(3) (1d6) Necrotic\
    \ damage."
  "name": "Rend"
- "desc": "Dexterity Saving Throw: DC 13, each creature in a 30-foot [Cone [Area\
    \ of Effect]](rules/variant-rules/cone-area-of-effect-xphb.md). Failure: dice:5d6|noform|avg|text(17)\
    \ (5d6) Necrotic damage. Success: Half damage. Failure or Success: A Humanoid\
    \ reduced to 0 [Hit Points](rules/variant-rules/hit-points-xphb.md) by this damage\
    \ dies, and a [Shadow](compendium/bestiary/undead/shadow-xmm.md) rises from its\
