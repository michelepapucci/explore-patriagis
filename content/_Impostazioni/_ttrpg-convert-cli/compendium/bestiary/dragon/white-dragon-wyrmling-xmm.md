...
- "desc": "Melee Attack: dice:1d20+4|noform|text(+4), reach 5 ft. Hit: dice:1d8+2|noform|avg|text(6)\
    \ (1d8 + 2) Slashing damage plus dice:1d4|noform|avg|text(2) (1d4) Cold\
    \ damage."
  "name": "Rend"
- "desc": "Constitution Saving Throw: DC 12, each creature in a 15-foot [Cone [Area\
    \ of Effect]](rules/variant-rules/cone-area-of-effect-xphb.md). Failure: dice:5d8|noform|avg|text(22)\
    \ (5d8) Cold damage. Success: Half damage."
  "name": "Cold Breath (Recharge 5-6)"
"source":
- "XMM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/XMM/White%20Dragon%20Wyrmling.webp"
```
^statblock
