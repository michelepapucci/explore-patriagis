...
- "desc": "Dexterity Saving Throw: DC 13, each creature in a 15-foot [Cone [Area\
    \ of Effect]](rules/variant-rules/cone-area-of-effect-xphb.md). Failure: dice:4d10|noform|avg|text(22)\
    \ (4d10) Fire damage. Success: Half damage."
  "name": "Fire Breath (Recharge 5-6)"
- "desc": "Strength Saving Throw: DC 13, each creature that isn't currently affected\
    \ by this breath in a 15-foot [Cone [Area of Effect]](rules/variant-rules/cone-area-of-effect-xphb.md).\
    ...
    \ dice:1d4|noform|avg|text(2) (1d4) from its damage rolls. It repeats the\
