...
- "desc": "The mephit explodes when it dies. Dexterity Saving Throw: DC 11, each\
    ...
    \ originating from the mephit. Failure: dice:2d6|noform|avg|text(7) (2d6)\
    \ Fire damage. Success: Half damage."
  "name": "Death Burst"
"actions":
- "desc": "Melee Attack: dice:1d20+3|noform|text(+3), reach 5 ft. Hit: dice:1d4+1|noform|avg|text(3)\
    \ (1d4 + 1) Slashing damage plus dice:1d6|noform|avg|text(3) (1d6) Fire\
    \ damage."
  "name": "Claw"
- "desc": "Dexterity Saving Throw: DC 11, each creature in a 15-foot [Cone [Area\
    \ of Effect]](rules/variant-rules/cone-area-of-effect-xphb.md). Failure: dice:2d6|noform|avg|text(7)\
    \ (2d6) Fire damage. Success: Half damage."
  "name": "Fire Breath (Recharge 6)"
"source":
- "XMM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/XMM/Magma%20Mephit.webp"
```
^statblock
