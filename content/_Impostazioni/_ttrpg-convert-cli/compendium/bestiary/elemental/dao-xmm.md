...
- "desc": "The dao casts one of the following spells, requiring no Material components\
    ...
    \ Magic](compendium/spells/detect-magic-xphb.md), [Stone Shape](compendium/spells/stone-shape-xphb.md)\n\
...
- "desc": "If the dao dies outside the Elemental Plane of Earth, its body dissolves\
    \ into dirt, and it gains a new body in dice:1d4|noform|avg (1d4) days, reviving\
    \ with all its [Hit Points](rules/variant-rules/hit-points-xphb.md) somewhere\
    \ on the Plane of Earth."
  "name": "Elemental Restoration"
- "desc": "The dao has [Advantage](rules/variant-rules/advantage-xphb.md) on saving\
...
- "desc": "The dao makes three Earthen Maul attacks or two Earth Burst attacks."
  "name": "Multiattack"
- "desc": "Melee Attack: dice:1d20+10|noform|text(+10), reach 5 ft. Hit: dice:4d6+6|noform|avg|text(20)\
    \ (4d6 + 6) Bludgeoning damage. If the target is a Large or smaller creature,\
    \ it has the [Prone](rules/conditions.md#Prone) condition."
  "name": "Earthen Maul"
- "desc": "Ranged Attack: dice:1d20+10|noform|text(+10), range 120 ft. Hit:\
    \ dice:2d8+6|noform|avg|text(15) (2d8 + 6) Bludgeoning damage. Hit or Miss:\
    \ Earth explodes from the target's space, creating the following effect. Dexterity\
    \ Saving Throw: DC 16, each creature in a 10-foot [Emanation [Area of Effect]](rules/variant-rules/emanation-area-of-effect-xphb.md)\
    \ originating from and including the target. Failure: dice:3d6|noform|avg|text(10)\
    \ (3d6) Thunder damage."
  "name": "Earth Burst"
"source":
- "XMM"
