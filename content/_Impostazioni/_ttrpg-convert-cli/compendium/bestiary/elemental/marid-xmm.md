...
- "desc": "If the marid dies outside the Elemental Plane of Water, its body dissolves\
    \ into brine, and it gains a new body in dice:1d4|noform|avg (1d4) days, reviving\
...
- "desc": "The marid makes three Aquatic Lash attacks."
  "name": "Multiattack"
- "desc": "Melee Attack: dice:1d20+10|noform|text(+10), reach 15 ft. Hit: dice:2d8+6|noform|avg|text(15)\
    \ (2d8 + 6) Slashing damage plus dice:2d8|noform|avg|text(9) (2d8) Cold\
    \ damage."
  "name": "Aquatic Lash"
- "desc": "Dexterity Saving Throw: DC 18, each creature in a 60-foot-long, 10-foot-wide\
    ...
    \ dice:9d6|noform|avg|text(31) (9d6) Cold damage. If the target is a Huge\
    \ or smaller creature, it is pushed up to 20 feet straight away from the marid\
    \ and has the [Prone](rules/conditions.md#Prone) condition. Success: Half damage\
    \ only."
  "name": "Water Jet"
"source":
- "XMM"
