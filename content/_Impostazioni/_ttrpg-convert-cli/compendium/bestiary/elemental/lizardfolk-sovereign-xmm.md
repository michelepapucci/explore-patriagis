...
- "desc": "Melee Attack: dice:1d20+5|noform|text(+5), reach 5 ft. Hit: dice:1d10+3|noform|avg|text(8)\
    \ (1d10 + 3) Piercing damage. If the target is a creature that isn't a Construct\
    \ or an Undead, the lizardfolk gains [Temporary Hit Points](rules/variant-rules/temporary-hit-points-xphb.md)\
...
- "desc": "Melee Attack: dice:1d20+5|noform|text(+5), reach 5 ft. Hit: dice:2d6+3|noform|avg|text(10)\
  ...
  "name": "Earthen Maul"
"bonus_actions":
- "desc": "The lizardfolk moves up to its [Speed](rules/variant-rules/speed-xphb.md)\
    \ or [Swim Speed](rules/variant-rules/swim-speed-xphb.md) straight toward an enemy\
    \ it can see."
  "name": "Charge"
"source":
- "XMM"
