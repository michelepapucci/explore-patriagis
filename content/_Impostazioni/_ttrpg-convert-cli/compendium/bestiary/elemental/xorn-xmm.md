...
- "desc": "The xorn makes one Bite attack and three Claw attacks."
  "name": "Multiattack"
- "desc": "Melee Attack: dice:1d20+6|noform|text(+6), reach 5 ft. Hit: dice:4d6+3|noform|avg|text(17)\
    \ (4d6 + 3) Piercing damage."
  "name": "Bite"
- "desc": "Melee Attack: dice:1d20+6|noform|text(+6), reach 5 ft. Hit: dice:1d10+3|noform|avg|text(8)\
    \ (1d10 + 3) Slashing damage."
  "name": "Claw"
"bonus_actions":
- "desc": "The xorn moves up to its [Speed](rules/variant-rules/speed-xphb.md) or\
    \ [Burrow Speed](rules/variant-rules/burrow-speed-xphb.md) straight toward an\
    \ enemy it can sense."
  "name": "Charge"
"source":
- "XMM"
