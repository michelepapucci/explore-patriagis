...
- "desc": "At the end of each of the elemental's turns, each creature in a 10-foot\
    ...
    \ originating from the elemental takes dice:1d10|noform|avg|text(5) (1d10)\
    \ Fire damage. Creatures and flammable objects in the [Emanation [Area of Effect]](rules/variant-rules/emanation-area-of-effect-xphb.md)\
...
- "desc": "The elemental can move through a space as narrow as 1 inch without expending\
    ...
    \ The first time it enters a creature's space on a turn, that creature takes dice:1d10|noform|avg|text(5)\
    \ (1d10) Fire damage."
  "name": "Fire Form"
- "desc": "The elemental sheds [Bright Light](rules/variant-rules/bright-light-xphb.md)\
    \ in a 30-foot radius and [Dim Light](rules/variant-rules/dim-light-xphb.md) for\
    \ an additional 30 feet."
  "name": "Illumination"
- "desc": "The elemental takes dice:1d6|noform|avg|text(3) (1d6) Cold damage for\
    \ every 5 feet the elemental moves in water or for every gallon of water splashed\
    \ on it."
