...
- "desc": "At the end of each of the salamander's turns, each creature of the salamander's\
    \ choice in a 10-foot [Emanation [Area of Effect]](rules/variant-rules/emanation-area-of-effect-xphb.md)\
    \ originating from the salamander takes dice:3d6|noform|avg|text(10) (3d6)\
    \ Fire damage."
  "name": "Fire Aura"
- "desc": "The salamander has [Advantage](rules/variant-rules/advantage-xphb.md) on\
...
- "desc": "Melee or Ranged Attack: dice:1d20+12|noform|text(+12), reach 5 ft.\
    \ or range 30/90 ft. Hit: dice:2d8+7|noform|avg|text(16) (2d8 + 7) Piercing\
    \ damage plus dice:4d6|noform|avg|text(14) (4d6) Fire damage. Hit or Miss:\
    \ The trident magically returns to the salamander's hand immediately after a ranged\
    \ attack."
  "name": "Flame Trident"
- "desc": "Dexterity Saving Throw: DC 18, each creature in a 30-foot-radius [Sphere\
    ...
    \ on a point the salamander can see within 120 feet. Failure: dice:10d6|noform|avg|text(35)\
    \ (10d6) Fire damage, and the target starts burning, taking dice:1d10|noform|avg|text(5)\
    \ (1d10) Fire damage at the start of each of its turns instead of the normal\
    \ burning damage. The target gains 1 [Exhaustion](rules/conditions.md#Exhaustion)\
    \ level whenever it takes this burning damage. Success: Half damage only."
  "name": "Inferno Blast (Recharge 5-6)"
"bonus_actions":
- "desc": "The salamander moves up to its [Speed](rules/variant-rules/speed-xphb.md)\
    ...
    \ originating from the salamander. When the [Emanation [Area of Effect]](rules/variant-rules/emanation-area-of-effect-xphb.md)\
    \ enters a creature's space, that creature takes dice:2d6|noform|avg|text(7)\
    \ (2d6) Fire damage. A creature can take this damage only once per turn."
  "name": "Blazing Movement"
"source":
- "XMM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/XMM/Salamander%20Inferno%20Master.webp"
```
^statblock
