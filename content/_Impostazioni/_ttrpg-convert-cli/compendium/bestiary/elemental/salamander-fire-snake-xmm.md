...
- "desc": "At the end of each of the salamander's turns, each creature of the salamander's\
    ...
    \ originating from the salamander takes dice:1d6|noform|avg|text(3) (1d6)\
    \ Fire damage."
  "name": "Fire Aura"
"actions":
- "desc": "Melee Attack: dice:1d20+4|noform|text(+4), reach 5 ft. Hit: dice:1d8+2|noform|avg|text(6)\
    \ (1d8 + 2) Piercing damage plus dice:1d6|noform|avg|text(3) (1d6) Fire\
    \ damage."
  "name": "Bite"
"source":
- "XMM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/XMM/Salamander%20Fire%20Snake.webp"
```
^statblock
