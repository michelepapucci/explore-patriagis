...
- "desc": "Melee or Ranged Attack: dice:1d20+7|noform|text(+7), reach 5 ft. or\
    \ range 60 ft. Hit: dice:3d10+4|noform|avg|text(20) (3d10 + 4) Cold damage.\
...
- "desc": "Trigger: An enemy the merfolk can see enters a space within 5 feet of the\
    ...
    \ Failure: dice:4d6|noform|avg|text(14) (4d6) Cold damage. If the target\
    \ is Large or smaller, it is pushed up to 30 feet straight away from the merfolk\
    \ by conjured water."
  "name": "Watery Rebuke"
"source":
- "XMM"
