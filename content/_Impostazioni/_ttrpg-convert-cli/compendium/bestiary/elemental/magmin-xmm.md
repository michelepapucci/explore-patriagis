...
- "desc": "The magmin explodes when it dies. Dexterity Saving Throw: DC 11, each\
    ...
    \ originating from the magmin. Failure: dice:2d6|noform|avg|text(7) (2d6)\
    \ Fire damage. Success: Half damage."
  "name": "Death Burst"
"actions":
- "desc": "Melee Attack: dice:1d20+4|noform|text(+4), reach 5 ft. Hit: dice:2d4+2|noform|avg|text(7)\
    \ (2d4 + 2) Fire damage. If the target is a creature or a flammable object that\
    \ isn't being worn or carried, it starts burning."
  "name": "Touch"
"bonus_actions":
- "desc": "The magmin sets itself ablaze or extinguishes its flames. While ablaze,\
    \ the magmin sheds [Bright Light](rules/variant-rules/bright-light-xphb.md) in\
    \ a 10-foot radius and [Dim Light](rules/variant-rules/dim-light-xphb.md) for\
