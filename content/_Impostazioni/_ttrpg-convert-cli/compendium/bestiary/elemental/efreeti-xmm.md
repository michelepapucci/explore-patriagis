...
- "desc": "If the efreeti dies outside the Elemental Plane of Fire, its body dissolves\
    \ into ash, and it gains a new body in dice:1d4|noform|avg (1d4) days, reviving\
    \ with all its [Hit Points](rules/variant-rules/hit-points-xphb.md) somewhere\
    \ on the Plane of Fire."
  "name": "Elemental Restoration"
- "desc": "The efreeti has [Advantage](rules/variant-rules/advantage-xphb.md) on saving\
...
- "desc": "The efreeti makes three attacks, using Heated Blade or Hurl Flame in any\
    \ combination."
  "name": "Multiattack"
- "desc": "Melee Attack: dice:1d20+10|noform|text(+10), reach 5 ft. Hit: dice:2d6+6|noform|avg|text(13)\
    \ (2d6 + 6) Slashing damage plus dice:2d12|noform|avg|text(13) (2d12) Fire\
    \ damage."
  "name": "Heated Blade"
- "desc": "Ranged Attack: dice:1d20+8|noform|text(+8), range 120 ft. Hit: dice:7d6|noform|avg|text(24)\
    \ (7d6) Fire damage."
  "name": "Hurl Flame"
"source":
- "XMM"
