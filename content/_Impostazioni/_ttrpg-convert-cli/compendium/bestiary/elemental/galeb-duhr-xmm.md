...
"cr": "6"
"actions":
- "desc": "Melee Attack: dice:1d20+8|noform|text(+8), reach 5 ft. Hit: dice:2d6+5|noform|avg|text(12)\
    \ (2d6 + 5) Bludgeoning damage. If the target is a Large or smaller creature\
    \ and the galeb duhr moved 20+ feet straight toward it immediately before the\
    \ hit, the target takes an extra dice:2d6|noform|avg|text(7) (2d6) Bludgeoning\
    \ damage and has the [Prone](rules/conditions.md#Prone) condition."
  "name": "Avalanche Slam"
- "desc": "The galeb duhr magically animates one or two boulders it can see within\
    ...
    \ its turn immediately after the galeb duhr on the same [Initiative](rules/variant-rules/initiative-xphb.md)\
