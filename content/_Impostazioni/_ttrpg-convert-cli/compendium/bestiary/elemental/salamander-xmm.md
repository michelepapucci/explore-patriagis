...
- "desc": "At the end of each of the salamander's turns, each creature of the salamander's\
    \ choice in a 5-foot [Emanation [Area of Effect]](rules/variant-rules/emanation-area-of-effect-xphb.md)\
    \ originating from the salamander takes dice:2d6|noform|avg|text(7) (2d6)\
    \ Fire damage."
  "name": "Fire Aura"
"actions":
...
- "desc": "Melee or Ranged Attack: dice:1d20+7|noform|text(+7), reach 5 ft. or\
    ...
    \ damage plus dice:2d6|noform|avg|text(7) (2d6) Fire damage. Hit or Miss:\
    \ The spear magically returns to the salamander's hand immediately after a ranged\
    \ attack."
  "name": "Flame Spear"
- "desc": "Strength Saving Throw: DC 15, one Large or smaller creature the salamander\
    \ can see within 10 feet. Failure: dice:2d6+4|noform|avg|text(11) (2d6 +\
    \ 4) Bludgeoning damage plus dice:2d6|noform|avg|text(7) (2d6) Fire damage.\
