...
- "desc": "The giant casts one of the following spells, requiring no Material components\
    ...
    \ [Detect Magic](compendium/spells/detect-magic-xphb.md), [Fog Cloud](compendium/spells/fog-cloud-xphb.md),\
...
- "desc": "The giant makes two attacks, using Thunderous Mace or Thundercloud in any\
    ...
    \ Cloud](compendium/spells/fog-cloud-xphb.md)."
  "name": "Multiattack"
- "desc": "Melee Attack: dice:1d20+12|noform|text(+12), reach 10 ft. Hit: dice:3d8+8|noform|avg|text(21)\
    \ (3d8 + 8) Bludgeoning damage plus dice:2d6|noform|avg|text(7) (2d6) Thunder\
    \ damage."
  "name": "Thunderous Mace"
- "desc": "Ranged Attack: dice:1d20+12|noform|text(+12), range 240 ft. Hit:\
    \ dice:3d6+8|noform|avg|text(18) (3d6 + 8) Thunder damage, and the target\
    \ has the [Incapacitated](rules/conditions.md#Incapacitated) condition until the\
