...
- "desc": "The giant makes two attacks, using Flame Sword or Hammer Throw in any combination."
  "name": "Multiattack"
- "desc": "Melee Attack: dice:1d20+11|noform|text(+11), reach 10 ft. Hit: dice:4d6+7|noform|avg|text(21)\
    \ (4d6 + 7) Slashing damage plus dice:3d6|noform|avg|text(10) (3d6) Fire\
    \ damage."
  "name": "Flame Sword"
- "desc": "Ranged Attack: dice:1d20+11|noform|text(+11), range 60/240 ft. Hit:\
    \ dice:3d10+7|noform|avg|text(23) (3d10 + 7) Bludgeoning damage plus dice:1d8|noform|avg|text(4)\
    \ (1d8) Fire damage, and the target is pushed up to 15 feet straight away from\
    \ the giant and has [Disadvantage](rules/variant-rules/disadvantage-xphb.md) on\
