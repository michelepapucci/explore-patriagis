...
- "desc": "Melee Attack: dice:1d20+8|noform|text(+8), reach 10 ft. Hit: dice:3d8+5|noform|avg|text(18)\
  ...
  "name": "Tree Club"
- "desc": "Ranged Attack: dice:1d20+8|noform|text(+8), range 60/240 ft. Hit:\
    \ dice:2d10+5|noform|avg|text(16) (2d10 + 5) Bludgeoning damage, and the target\
    \ has the [Poisoned](rules/conditions.md#Poisoned) condition until the end of\
    \ its next turn."
  "name": "Trash Lob"
"source":
- "XMM"
