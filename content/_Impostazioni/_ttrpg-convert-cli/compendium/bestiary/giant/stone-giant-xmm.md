...
- "desc": "The giant makes two attacks, using Stone Club or Boulder in any combination."
  "name": "Multiattack"
- "desc": "Melee Attack: dice:1d20+9|noform|text(+9), reach 15 ft. Hit: dice:3d10+6|noform|avg|text(22)\
    \ (3d10 + 6) Bludgeoning damage."
  "name": "Stone Club"
- "desc": "Ranged Attack: dice:1d20+9|noform|text(+9), range 60/240 ft. Hit:\
    \ dice:2d8+6|noform|avg|text(15) (2d8 + 6) Bludgeoning damage. If the target\
    \ is a Large or smaller creature, it has the [Prone](rules/conditions.md#Prone)\
    \ condition."
  "name": "Boulder"
"reactions":
- "desc": "Trigger: The giant is hit by a ranged attack roll and takes Bludgeoning,\
    ...
    \ it takes from the attack by dice:1d10+6|noform|avg|text(11) (1d10 + 6),\
    \ and if that damage is reduced to 0, the giant can redirect some of the attack's\
    \ force. Dexterity Saving Throw: DC 17, one creature the giant can see within\
    \ 60 feet. Failure: dice:1d10+6|noform|avg|text(11) (1d10 + 6) Force damage."
  "name": "Deflect Missile (Recharge 5-6)"
"source":
- "XMM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/XMM/Stone%20Giant.webp"
```
^statblock
