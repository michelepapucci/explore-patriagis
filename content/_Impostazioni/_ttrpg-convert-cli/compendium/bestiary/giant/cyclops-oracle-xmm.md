...
- "desc": "The cyclops makes three attacks, using Radiant Strike or Flash of Light\
    \ in any combination."
  "name": "Multiattack"
- "desc": "Melee Attack: dice:1d20+10|noform|text(+10), reach 10 ft. Hit: dice:3d10+6|noform|avg|text(22)\
    \ (3d10 + 6) Radiant damage."
  "name": "Radiant Strike"
- "desc": "Ranged Attack: dice:1d20+10|noform|text(+10), range 120 ft. Hit:\
    \ dice:2d10+6|noform|avg|text(17) (2d10 + 6) Radiant damage, and the target\
    \ has [Disadvantage](rules/variant-rules/disadvantage-xphb.md) on attack rolls\
    \ until the end of the cyclops's next turn."
  "name": "Flash of Light"
"reactions":
- "desc": "Trigger: The cyclops or an ally it can see makes a [D20 Test](rules/variant-rules/d20-test-xphb.md).\
    \ Response: The cyclops rolls dice:1d20|noform|avg () and chooses whether\
    \ to use that roll in place of the dice:d20|noform|avg (d20) rolled for the\
    \ [D20 Test](rules/variant-rules/d20-test-xphb.md)."
