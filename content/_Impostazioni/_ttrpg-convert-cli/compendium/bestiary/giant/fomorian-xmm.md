...
- "desc": "The fomorian makes two Stone Club attacks. It can replace one attack with\
  ...
  "name": "Multiattack"
- "desc": "Melee Attack: dice:1d20+9|noform|text(+9), reach 15 ft. Hit: dice:4d8+6|noform|avg|text(24)\
    \ (4d8 + 6) Bludgeoning damage."
  "name": "Stone Club"
- "desc": "Wisdom Saving Throw: DC 16, one creature the fomorian can see within\
    \ 120 feet. Failure: dice:6d6|noform|avg|text(21) (6d6) Psychic damage,\
    \ and the target gains 1 [Exhaustion](rules/conditions.md#Exhaustion) level. Success:\
    \ Half damage only."
