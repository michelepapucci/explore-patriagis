...
- "desc": "The ettin makes one Battleaxe attack and one Morningstar attack."
  "name": "Multiattack"
- "desc": "Melee Attack: dice:1d20+7|noform|text(+7), reach 5 ft. Hit: dice:2d8+5|noform|avg|text(14)\
    \ (2d8 + 5) Slashing damage. If the target is a Large or smaller creature, it\
    \ has the [Prone](rules/conditions.md#Prone) condition."
  "name": "Battleaxe"
- "desc": "Melee Attack: dice:1d20+7|noform|text(+7), reach 5 ft. Hit: dice:2d8+5|noform|avg|text(14)\
    \ (2d8 + 5) Piercing damage, and the target has [Disadvantage](rules/variant-rules/disadvantage-xphb.md)\
