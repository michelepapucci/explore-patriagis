...
"cr": "6"
"traits":
- "desc": "While in a 30-foot [Emanation [Area of Effect]](rules/variant-rules/emanation-area-of-effect-xphb.md)\
...
- "desc": "Melee or Ranged Attack: dice:1d20+6|noform|text(+6), reach 5 ft. or\
    \ range 30/120 ft. Hit: dice:2d6+4|noform|avg|text(11) (2d6 + 4) Piercing\
    \ damage, and the target's [Speed](rules/variant-rules/speed-xphb.md) decreases\
    \ by 10 feet until the start of the hobgoblin's next turn."
  "name": "Javelin"
