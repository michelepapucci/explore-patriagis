...
- "desc": "Melee Attack: dice:1d20+5|noform|text(+5), reach 5 ft. Hit: dice:1d8+3|noform|avg|text(7)\
    \ (1d8 + 3) Piercing damage, and the next attack roll made against the target\
    \ before the start of the worg's next turn has [Advantage](rules/variant-rules/advantage-xphb.md)."
  "name": "Bite"
"source":
- "XMM"
