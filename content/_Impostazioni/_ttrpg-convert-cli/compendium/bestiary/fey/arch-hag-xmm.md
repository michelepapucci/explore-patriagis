...
- "desc": "When the hag drops to 0 [Hit Points](rules/variant-rules/hit-points-xphb.md),\
    \ it dies only if it is within 30 feet of its anathema (a thing the DM chooses\
    \ as the hag's most hated thing). Otherwise, the hag drops to 1 [Hit Points](rules/variant-rules/hit-points-xphb.md)\
    \ and teleports to a harmless demiplane, and it can't return to the plane it left\
    \ for dice:2d6|noform|avg (2d6) days. When the hag teleports away, each creature\
    \ within 60 feet of the space it left is cursed. Until the curse ends, a creature\
    \ has [Disadvantage](rules/variant-rules/disadvantage-xphb.md) on ability checks\
...
- "desc": "The hag makes two Spectral Claw attacks and uses Crackling Wave."
  "name": "Multiattack"
- "desc": "Melee or Ranged Attack: dice:1d20+14|noform|text(+14), reach 10 ft.\
    \ or range 60 ft. Hit: dice:3d6+7|noform|avg|text(17) (3d6 + 7) Force damage.\
    \ If the target is a Large or smaller creature, it has the [Prone](rules/conditions.md#Prone)\
    \ condition."
  "name": "Spectral Claw"
- "desc": "Dexterity Saving Throw: DC 22, each creature in a 60-foot [Cone [Area\
    \ of Effect]](rules/variant-rules/cone-area-of-effect-xphb.md). Failure: dice:5d12|noform|avg|text(32)\
    \ (5d12) Lightning damage. Success: Half damage. Failure or Success: The\
    \ target is cursed until the end of the hag's next turn. The target can't take\
    \ Reactions until the curse ends."
  "name": "Crackling Wave"
"bonus_actions":
- "desc": "Each creature cursed by the hag and within 60 feet of it takes dice:4d6|noform|avg|text(14)\
...
- "desc": "- Lapsus Linguae. Creatures (excluding the hag and its allies) within\
    \ 1 mile of the lair subtract dice:1d10|noform|avg (1d10) from any ability\
    \ check they make when they take the [Influence](rules/actions.md#Influence) action.\
    \  \n- Meddlesome Magic. Whenever a creature other than the hag or its allies\
    \ finishes a [Long Rest](rules/variant-rules/long-rest-xphb.md) while within 1\
    \ mile of the lair, the next time that creature casts a spell using a spell slot,\
    \ it also casts [Confusion](compendium/spells/confusion-xphb.md) centered on itself.\
    \ The spell uses the creature's spellcasting ability and doesn't require [Concentration](rules/conditions.md#Concentration).\
    \  "
  "name": ""
