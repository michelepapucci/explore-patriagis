...
- "desc": "The centaur moves up to its [Speed](rules/variant-rules/speed-xphb.md)\
    ...
    \ once by the following effect. Strength Saving Throw: DC 14. Failure: dice:1d6+4|noform|avg|text(7)\
    \ (1d6 + 4) Bludgeoning damage, and the target has the [Prone](rules/conditions.md#Prone)\
    \ condition."
