...
"cr": "10"
"traits":
- "desc": "The worg has [Advantage](rules/variant-rules/advantage-xphb.md) on saving\
    \ throws against spells and other magical effects."
  "name": "Magic Resistance"
"actions":
- "desc": "The worg makes three Bite attacks."
  "name": "Multiattack"
- "desc": "Melee Attack: dice:1d20+10|noform|text(+10), reach 5 ft. Hit: dice:2d8+6|noform|avg|text(15)\
    \ (2d8 + 6) Piercing damage plus dice:2d6|noform|avg|text(7) (2d6) Poison\
    \ damage, and the target has the [Poisoned](rules/conditions.md#Poisoned) condition\
    \ until the start of the worg's next turn. While [Poisoned](rules/conditions.md#Poisoned),\
...
- "desc": "Wisdom Saving Throw: DC 16, each creature within 30 feet that isn't a\
    \ worg. Failure: dice:8d8|noform|avg|text(36) (8d8) Psychic damage, and\
    \ the target has the [Frightened](rules/conditions.md#Frightened) condition until\
    \ the start of the worg's next turn. Success: Half damage only."
