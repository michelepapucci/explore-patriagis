...
- "desc": "The bullywug casts one of the following spells, using Wisdom as the spellcasting\
    ...
    \nAt will: [Dancing Lights](compendium/spells/dancing-lights-xphb.md), [Druidcraft](compendium/spells/druidcraft-xphb.md),\
...
- "desc": "Melee Attack: dice:1d20+5|noform|text(+5), reach 5 ft. Hit: dice:1d8+3|noform|avg|text(7)\
    \ (1d8 + 3) Bludgeoning damage plus dice:3d6|noform|avg|text(10) (3d6) Poison\
    \ damage."
  "name": "Bog Staff"
"bonus_actions":
