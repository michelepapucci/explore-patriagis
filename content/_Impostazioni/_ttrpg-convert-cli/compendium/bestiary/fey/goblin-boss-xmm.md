...
- "desc": "Melee Attack: dice:1d20+4|noform|text(+4), reach 5 ft. Hit: dice:1d6+2|noform|avg|text(5)\
    \ (1d6 + 2) Slashing damage, plus dice:1d4|noform|avg|text(2) (1d4) Slashing\
    \ damage if the attack roll had [Advantage](rules/variant-rules/advantage-xphb.md)."
  "name": "Scimitar"
- "desc": "Ranged Attack: dice:1d20+4|noform|text(+4), range 80/320 ft. Hit:\
    \ dice:1d6+2|noform|avg|text(5) (1d6 + 2) Piercing damage, plus dice:1d4|noform|avg|text(2)\
    \ (1d4) Piercing damage if the attack roll had [Advantage](rules/variant-rules/advantage-xphb.md)."
  "name": "Shortbow"
"bonus_actions":
...
"source":
- "XMM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/XMM/Goblin%20Boss.webp"
```
^statblock
