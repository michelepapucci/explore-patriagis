...
- "desc": "The dryad casts one of the following spells, requiring no Material components\
  ...
  "name": "Spellcasting"
- "desc": "The dryad has [Advantage](rules/variant-rules/advantage-xphb.md) on saving\
...
- "desc": "The dryad makes one Vine Lash or Thorn Burst attack, and it can use Spellcasting\
  ...
  "name": "Multiattack"
- "desc": "Melee Attack: dice:1d20+6|noform|text(+6), reach 10 ft. Hit: dice:1d8+4|noform|avg|text(8)\
    \ (1d8 + 4) Slashing damage."
  "name": "Vine Lash"
- "desc": "Ranged Attack: dice:1d20+6|noform|text(+6), range 60 ft. Hit: dice:1d6+4|noform|avg|text(7)\
