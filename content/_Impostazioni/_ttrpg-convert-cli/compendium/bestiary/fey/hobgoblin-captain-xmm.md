...
"cr": "3"
"traits":
- "desc": "While in a 10-foot [Emanation [Area of Effect]](rules/variant-rules/emanation-area-of-effect-xphb.md)\
    \ originating from the hobgoblin, the hobgoblin and its allies have [Advantage](rules/variant-rules/advantage-xphb.md)\
    \ on attack rolls and saving throws, provided the hobgoblin doesn't have the [Incapacitated](rules/conditions.md#Incapacitated)\
    \ condition."
  "name": "Aura of Authority"
"actions":
- "desc": "The hobgoblin makes two attacks, using Greatsword or Longbow in any combination."
  "name": "Multiattack"
- "desc": "Melee Attack: dice:1d20+4|noform|text(+4), reach 5 ft. Hit: dice:2d6+2|noform|avg|text(9)\
    \ (2d6 + 2) Slashing damage plus dice:1d6|noform|avg|text(3) (1d6) Poison\
    \ damage."
  "name": "Greatsword"
- "desc": "Ranged Attack: dice:1d20+4|noform|text(+4), range 150/600 ft. Hit:\
    \ dice:1d8+2|noform|avg|text(6) (1d8 + 2) Piercing damage plus dice:2d4|noform|avg|text(5)\
    \ (2d4) Poison damage."
  "name": "Longbow"
"source":
- "XMM"
