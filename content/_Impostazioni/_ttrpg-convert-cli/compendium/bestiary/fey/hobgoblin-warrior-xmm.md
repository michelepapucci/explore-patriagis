...
"cr": "1/2"
"traits":
- "desc": "The hobgoblin has [Advantage](rules/variant-rules/advantage-xphb.md) on\
    \ an attack roll against a creature if at least one of the hobgoblin's allies\
    \ is within 5 feet of the creature and the ally doesn't have the [Incapacitated](rules/conditions.md#Incapacitated)\
    \ condition."
  "name": "Pack Tactics"
"actions":
- "desc": "Melee Attack: dice:1d20+3|noform|text(+3), reach 5 ft. Hit: dice:2d10+1|noform|avg|text(12)\
    \ (2d10 + 1) Slashing damage."
  "name": "Longsword"
- "desc": "Ranged Attack: dice:1d20+3|noform|text(+3), range 150/600 ft. Hit:\
    \ dice:1d8+1|noform|avg|text(5) (1d8 + 1) Piercing damage plus dice:3d4|noform|avg|text(7)\
    \ (3d4) Poison damage."
  "name": "Longbow"
"source":
- "XMM"
