...
"cr": "3"
"traits":
- "desc": "If the swarm dies in the Nine Hells, it revives with all its [Hit Points](rules/variant-rules/hit-points-xphb.md)\
...
- "desc": "Melee Attack: dice:1d20+4|noform|text(+4), reach 5 ft. Hit: dice:2d8+2|noform|avg|text(11)\
    \ (2d8 + 2) Poison damage, or dice:2d6+2|noform|avg|text(9) (2d6 + 2) Poison\
