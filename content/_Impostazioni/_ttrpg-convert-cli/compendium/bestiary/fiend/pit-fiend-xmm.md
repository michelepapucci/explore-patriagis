...
- "desc": "The pit fiend emanates an aura in a 20-foot [Emanation [Area of Effect]](rules/variant-rules/emanation-area-of-effect-xphb.md)\
    ...
    \ aura. Failure: The target has the [Frightened](rules/conditions.md#Frightened)\
...
- "desc": "The pit fiend has [Advantage](rules/variant-rules/advantage-xphb.md) on\
...
- "desc": "The pit fiend makes one Bite attack, two Devilish Claw attacks, and one\
    \ Fiery Mace attack."
  "name": "Multiattack"
- "desc": "Melee Attack: dice:1d20+14|noform|text(+14), reach 10 ft. Hit: dice:3d6+8|noform|avg|text(18)\
    \ (3d6 + 8) Piercing damage. If the target is a creature, it must make the following\
    \ saving throw. Constitution Saving Throw: DC 21. Failure: The target has\
    \ the [Poisoned](rules/conditions.md#Poisoned) condition. While [Poisoned](rules/conditions.md#Poisoned),\
    \ the target can't regain [Hit Points](rules/variant-rules/hit-points-xphb.md)\
    \ and takes dice:6d6|noform|avg|text(21) (6d6) Poison damage at the start\
    \ of each of its turns, and it repeats the save at the end of each of its turns,\
    \ ending the effect on itself on a success. After 1 minute, it succeeds automatically."
  "name": "Bite"
- "desc": "Melee Attack: dice:1d20+14|noform|text(+14), reach 10 ft. Hit: dice:4d8+8|noform|avg|text(26)\
    \ (4d8 + 8) Necrotic damage."
  "name": "Devilish Claw"
- "desc": "Melee Attack: dice:1d20+14|noform|text(+14), reach 10 ft. Hit: dice:4d6+8|noform|avg|text(22)\
    \ (4d6 + 8) Force damage plus dice:6d6|noform|avg|text(21) (6d6) Fire damage."
  "name": "Fiery Mace"
"source":
- "XMM"
