...
- "desc": "The yochlol casts one of the following spells, requiring no Material components\
    ...
    \ [Detect Thoughts](compendium/spells/detect-thoughts-xphb.md), [Gaseous Form](compendium/spells/gaseous-form-xphb.md)\
    \ (self only), [Web](compendium/spells/web-xphb.md)\n\n1/day: [Dominate Person](compendium/spells/dominate-person-xphb.md)"
  "name": "Spellcasting"
...
- "desc": "The yochlol has [Advantage](rules/variant-rules/advantage-xphb.md) on saving\
...
- "desc": "The yochlol makes two Caustic Lash attacks, and it can use Spellcasting\
    ...
    \ if available."
  "name": "Multiattack"
- "desc": "Melee or Ranged Attack: dice:1d20+8|noform|text(+8), reach 10 ft. or\
    \ range 120 ft. Hit: dice:6d6+4|noform|avg|text(25) (6d6 + 4) Acid damage."
  "name": "Caustic Lash"
"bonus_actions":
...
- "desc": "Trigger: The yochlol is hit by an attack roll. Response: The yochlol halves\
    ...
    \ target has the [Poisoned](rules/conditions.md#Poisoned) condition until the\
    \ end of its next turn. While [Poisoned](rules/conditions.md#Poisoned), it has\
    \ the [Incapacitated](rules/conditions.md#Incapacitated) condition."
  "name": "Toxic Escape"
"source":
- "XMM"
