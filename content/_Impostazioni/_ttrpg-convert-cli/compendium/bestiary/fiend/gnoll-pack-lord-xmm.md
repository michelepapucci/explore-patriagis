...
- "desc": "The gnoll makes two attacks, using Bone Whip or Bone Javelin in any combination,\
  ...
  "name": "Multiattack"
- "desc": "Melee Attack: dice:1d20+5|noform|text(+5), reach 10 ft. Hit: dice:2d4+3|noform|avg|text(8)\
    \ (2d4 + 3) Slashing damage."
  "name": "Bone Whip"
- "desc": "Ranged Attack: dice:1d20+5|noform|text(+5), range 30/120 ft. Hit:\
    \ dice:1d8+3|noform|avg|text(7) (1d8 + 3) Piercing damage."
  "name": "Bone Javelin"
- "desc": "The gnoll targets another creature it can see within 60 feet of itself\
    \ that has the Rampage [Bonus Action](rules/variant-rules/bonus-action-xphb.md).\
    \ The target can take a [Reaction](rules/variant-rules/reaction-xphb.md) to make\
    \ one melee attack."
...
- "desc": "Immediately after dealing damage to a creature that is already [Bloodied](rules/variant-rules/bloodied-xphb.md),\
    ...
    \ it makes one Bone Whip attack."
  "name": "Rampage (2/Day)"
"source":
- "XMM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/XMM/Gnoll%20Pack%20Lord.webp"
```
^statblock
