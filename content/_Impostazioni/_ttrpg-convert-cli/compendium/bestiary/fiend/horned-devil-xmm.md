...
- "desc": "The devil makes three attacks, using Searing Fork or Hurl Flame in any\
  ...
  "name": "Multiattack"
- "desc": "Melee Attack: dice:1d20+10|noform|text(+10), reach 10 ft. Hit: dice:2d8+6|noform|avg|text(15)\
    \ (2d8 + 6) Piercing damage plus dice:2d8|noform|avg|text(9) (2d8) Fire\
    \ damage."
  "name": "Searing Fork"
- "desc": "Ranged Attack: dice:1d20+8|noform|text(+8), range 150 ft. Hit: dice:5d8+4|noform|avg|text(26)\
    \ (5d8 + 4) Fire damage. If the target is a flammable object that isn't being\
    \ worn or carried, it starts burning."
  "name": "Hurl Flame"
- "desc": "Dexterity Saving Throw: DC 17, one creature the devil can see within\
    \ 10 feet. Failure: dice:1d8+6|noform|avg|text(10) (1d8 + 6) Necrotic damage,\
    \ and the target receives an infernal wound if it doesn't have one. While wounded,\
    \ the target loses dice:3d6|noform|avg|text(10) (3d6) [Hit Points](rules/variant-rules/hit-points-xphb.md)\
    ...
    \ the wound, doing so by succeeding on a DC 17 Wisdom ([Medicine](rules/skills.md#Medicine))\
    \ check."
  "name": "Infernal Tail"
"source":
- "XMM"
