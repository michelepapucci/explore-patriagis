...
- "desc": "The devil makes three Ice Spear attacks. It can replace one attack with\
    \ a Tail attack."
  "name": "Multiattack"
- "desc": "Melee or Ranged Attack: dice:1d20+10|noform|text(+10), reach 5 ft.\
    \ or range 30/120 ft. Hit: dice:2d8+5|noform|avg|text(14) (2d8 + 5) Piercing\
    \ damage plus dice:3d6|noform|avg|text(10) (3d6) Cold damage. Until the end\
    \ of its next turn, the target can't take a [Bonus Action](rules/variant-rules/bonus-action-xphb.md)\
    \ or [Reaction](rules/variant-rules/reaction-xphb.md), its [Speed](rules/variant-rules/speed-xphb.md)\
    ...
    \ a ranged attack."
  "name": "Ice Spear"
- "desc": "Melee Attack: dice:1d20+10|noform|text(+10), reach 10 ft. Hit: dice:3d6+5|noform|avg|text(15)\
    \ (3d6 + 5) Bludgeoning damage plus dice:4d8|noform|avg|text(18) (4d8) Cold\
    \ damage."
  "name": "Tail"
"source":
- "XMM"
