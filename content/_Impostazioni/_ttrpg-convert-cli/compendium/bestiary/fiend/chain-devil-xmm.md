...
- "desc": "Melee Attack: dice:1d20+7|noform|text(+7), reach 10 ft. Hit: dice:2d6+4|noform|avg|text(11)\
    ...
    \ one of two chains, and it has the [Restrained](rules/conditions.md#Restrained)\
    \ condition until the grapple ends."
  "name": "Chain"
- "desc": "The devil conjures a fiery chain to bind a creature. Dexterity Saving\
    \ Throw: DC 15, one creature the devil can see within 60 feet. Failure: dice:2d4+4|noform|avg|text(9)\
    \ (2d4 + 4) Fire damage, and the target has the [Restrained](rules/conditions.md#Restrained)\
...
- "desc": "Trigger: A creature the devil can see starts its turn within 30 feet of\
    ...
    \ the triggering creature. Failure: The target has the [Frightened](rules/conditions.md#Frightened)\
