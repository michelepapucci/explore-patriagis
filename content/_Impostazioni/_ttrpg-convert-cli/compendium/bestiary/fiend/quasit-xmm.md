...
- "desc": "The quasit casts [Invisibility](compendium/spells/invisibility-xphb.md)\
  ...
  "name": "Invisibility"
- "desc": "The quasit has [Advantage](rules/variant-rules/advantage-xphb.md) on saving\
    \ throws against spells and other magical effects."
  "name": "Magic Resistance"
"actions":
- "desc": "Melee Attack: dice:1d20+5|noform|text(+5), reach 5 ft. Hit: dice:1d4+3|noform|avg|text(5)\
    \ (1d4 + 3) Slashing damage, and the target has the [Poisoned](rules/conditions.md#Poisoned)\
...
- "desc": "Wisdom Saving Throw: DC 10, one creature within 20 feet. Failure: The\
    \ target has the [Frightened](rules/conditions.md#Frightened) condition. At the\
    \ end of each of its turns, the target repeats the save, ending the effect on\
    \ itself on a success. After 1 minute, it succeeds automatically."
  "name": "Scare (1/Day)"
- "desc": "The quasit shape-shifts to resemble a bat ([Speed](rules/variant-rules/speed-xphb.md)\
    ...
    \ in each form, except for its [Speed](rules/variant-rules/speed-xphb.md). Any\
