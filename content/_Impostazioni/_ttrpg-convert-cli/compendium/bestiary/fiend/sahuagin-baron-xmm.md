...
"cr": "5"
"traits":
- "desc": "The sahuagin has [Advantage](rules/variant-rules/advantage-xphb.md) on\
...
- "desc": "Melee or Ranged Attack: dice:1d20+7|noform|text(+7), reach 5 ft. or\
    \ range 20/60 ft. Hit: dice:2d8+4|noform|avg|text(13) (2d8 + 4) Piercing\
    \ damage."
  "name": "Trident"
"reactions":
- "desc": "Trigger: The sahuagin takes Piercing or Slashing damage. {@actResponse\
    ...
    \ originating from the sahuagin. Failure: dice:3d6|noform|avg|text(10) (3d6)\
    \ Acid damage, and the target is cursed until it finishes a [Short Rest](rules/variant-rules/short-rest-xphb.md)\
    \ or [Long Rest](rules/variant-rules/long-rest-xphb.md). While cursed, the target\
    \ can't benefit from the [Invisible](rules/conditions.md#Invisible) condition,\
    \ its [Speed](rules/variant-rules/speed-xphb.md) decreases by 10 feet, and all\
    \ Fiends within 120 feet of the target can sense its location regardless of interposing\
    \ obstacles."
  "name": "Fiendish Blood"
"source":
- "XMM"
