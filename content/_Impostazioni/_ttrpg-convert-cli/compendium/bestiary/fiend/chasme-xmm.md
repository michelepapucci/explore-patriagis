...
- "desc": "The chasme has [Advantage](rules/variant-rules/advantage-xphb.md) on saving\
...
- "desc": "Melee Attack: dice:1d20+5|noform|text(+5), reach 5 ft. Hit: dice:4d6+2|noform|avg|text(16)\
    \ (4d6 + 2) Piercing damage plus dice:6d6|noform|avg|text(21) (6d6) Necrotic\
    \ damage. If the target is a creature, its [Hit Points](rules/variant-rules/hit-points-xphb.md)\
...
- "desc": "Constitution Saving Throw: DC 12, each creature in a 30-foot [Emanation\
    ...
    \ target has the [Unconscious](rules/conditions.md#Unconscious) condition and\
    \ repeats the save at the end of each of its turns. The target succeeds automatically\
    \ after 10 minutes or if it takes damage or a creature within 5 feet of it takes\
    \ an action to empty a flask of Holy Water on it. Success: The target is immune\
    \ to this chasme's Drone for 24 hours."
  "name": "Drone"
"source":
- "XMM"
