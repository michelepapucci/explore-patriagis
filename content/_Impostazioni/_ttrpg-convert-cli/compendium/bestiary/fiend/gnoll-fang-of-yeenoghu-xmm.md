...
- "desc": "Melee Attack: dice:1d20+5|noform|text(+5), reach 5 ft. Hit: dice:1d6+3|noform|avg|text(6)\
    \ (1d6 + 3) Piercing damage plus dice:2d6|noform|avg|text(7) (2d6) Poison\
...
- "desc": "Immediately after dealing damage to a creature that is already [Bloodied](rules/variant-rules/bloodied-xphb.md),\
    ...
    \ it makes one Bite attack."
  "name": "Rampage (2/Day)"
"source":
- "XMM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/XMM/Gnoll%20Fang%20of%20Yeenoghu.webp"
```
^statblock
