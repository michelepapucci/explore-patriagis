...
- "desc": "The goristro has [Advantage](rules/variant-rules/advantage-xphb.md) on\
...
- "desc": "The goristro makes one Brutal Gore attack and two Slam attacks."
  "name": "Multiattack"
- "desc": "Melee Attack: dice:1d20+13|noform|text(+13), reach 10 ft. Hit: dice:6d10+7|noform|avg|text(40)\
    \ (6d10 + 7) Piercing damage. If the target is a Huge or smaller creature, it\
    \ is pushed up to 20 feet straight away from the goristro and has the [Prone](rules/conditions.md#Prone)\
    \ condition."
  "name": "Brutal Gore"
- "desc": "Melee Attack: dice:1d20+13|noform|text(+13), reach 10 ft. Hit: dice:4d10+7|noform|avg|text(29)\
    \ (4d10 + 7) Bludgeoning damage."
  "name": "Slam"
"bonus_actions":
- "desc": "The goristro moves up to half its [Speed](rules/variant-rules/speed-xphb.md)\
