...
- "desc": "The incubus casts one of the following spells, requiring no Material components\
  ...
  "name": "Spellcasting"
- "desc": "When the incubus finishes a [Long Rest](rules/variant-rules/long-rest-xphb.md),\
...
- "desc": "The incubus makes two Restless Touch attacks."
  "name": "Multiattack"
- "desc": "Melee Attack: dice:1d20+7|noform|text(+7), reach 5 ft. Hit: dice:3d6+5|noform|avg|text(15)\
    \ (3d6 + 5) Psychic damage, and the target is cursed for 24 hours or until the\
    \ incubus dies. Until the curse ends, the target gains no benefit from finishing\
    \ Short Rests."
  "name": "Restless Touch"
"bonus_actions":
- "desc": "Wisdom Saving Throw: DC 15, one creature the incubus can see within 60\
    \ feet. Failure: If the target has 20 [Hit Points](rules/variant-rules/hit-points-xphb.md)\
    \ or fewer, it has the [Unconscious](rules/conditions.md#Unconscious) condition\
    \ for 1 hour, until it takes damage, or until a creature within 5 feet of it takes\
    \ an action to wake it. Otherwise, the target takes dice:4d8|noform|avg|text(18)\
    \ (4d8) Psychic damage."
