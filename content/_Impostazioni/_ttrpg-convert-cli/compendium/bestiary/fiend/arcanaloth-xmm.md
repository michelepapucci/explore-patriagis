...
- "desc": "The arcanaloth casts one of the following spells, requiring no Material\
    ...
    \ 17):\n\nAt will: [Alter Self](compendium/spells/alter-self-xphb.md), [Detect\
    \ Magic](compendium/spells/detect-magic-xphb.md), [Identify](compendium/spells/identify-xphb.md),\
...
- "desc": "If the arcanaloth dies outside Gehenna, its body dissolves into ichor,\
    \ and it gains a new body instantly and revives with all its [Hit Points](rules/variant-rules/hit-points-xphb.md)\
    \ in Gehenna."
  "name": "Fiendish Restoration"
- "desc": "The arcanaloth has [Advantage](rules/variant-rules/advantage-xphb.md) on\
...
- "desc": "The arcanaloth has a magic tome. While holding or carrying the tome, the\
    ...
    \ and [Immunity](rules/variant-rules/immunity-xphb.md) to Necrotic, Poison, and\
    \ Psychic damage. The tome regains all its [Hit Points](rules/variant-rules/hit-points-xphb.md)\
    ...
    \ a new one when it finishes a [Short Rest](rules/variant-rules/short-rest-xphb.md)\
...
- "desc": "Melee or Ranged Attack: dice:1d20+9|noform|text(+9), reach 5 ft. or\
    \ range 120 ft. Hit: dice:4d12+5|noform|avg|text(31) (4d12 + 5) Necrotic\
    \ damage."
  "name": "Fiendish Burst"
- "desc": "Melee Attack: dice:1d20+9|noform|text(+9), reach 5 ft. Hit: dice:2d4+5|noform|avg|text(10)\
    \ (2d4 + 5) Slashing damage plus dice:3d12|noform|avg|text(19) (3d12) Psychic\
    \ damage. If the target is a creature, it is subjected to the following effect.\
    \ Charisma Saving Throw: DC 17. Failure: The target is trapped in a demiplane\
    \ inside the Soul Tome. While trapped there, the target has the [Incapacitated](rules/conditions.md#Incapacitated)\
    \ condition. At the end of each of its turns, the target repeats the save, escaping\
    \ the tome on a success. When the target escapes, it appears in the space it left\
    \ or, if that space is occupied, the nearest unoccupied space.\n\nIf the target\
    \ fails three of these saves while in the demiplane, it becomes bound to the tome\
    \ and can escape only if the tome is reduced to 0 [Hit Points](rules/variant-rules/hit-points-xphb.md)."
