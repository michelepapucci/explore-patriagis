...
- "desc": "The glabrezu has [Advantage](rules/variant-rules/advantage-xphb.md) on\
    \ saving throws against spells and other magical effects."
  "name": "Magic Resistance"
"actions":
- "desc": "The glabrezu makes two Pincer attacks and uses Pummel or Spellcasting."
  "name": "Multiattack"
- "desc": "Melee Attack: dice:1d20+9|noform|text(+9), reach 10 ft. Hit: dice:2d10+5|noform|avg|text(16)\
    \ (2d10 + 5) Slashing damage. If the target is a Medium or smaller creature,\
    \ it has the [Grappled](rules/conditions.md#Grappled) condition (escape DC 15)\
    \ from one of two pincers."
  "name": "Pincer"
- "desc": "Dexterity Saving Throw: DC 17, one creature [Grappled](rules/conditions.md#Grappled)\
    \ by the glabrezu. Failure: dice:3d6+5|noform|avg|text(15) (3d6 + 5) Bludgeoning\
