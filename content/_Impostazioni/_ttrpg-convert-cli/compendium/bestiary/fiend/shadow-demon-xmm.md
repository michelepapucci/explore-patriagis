...
- "desc": "While in [Bright Light](rules/variant-rules/bright-light-xphb.md), the\
    \ demon has [Disadvantage](rules/variant-rules/disadvantage-xphb.md) on ability\
    \ checks and attack rolls."
  "name": "Light Sensitivity"
"actions":
- "desc": "Melee Attack: dice:1d20+5|noform|text(+5), reach 5 ft. Hit: dice:3d8+3|noform|avg|text(16)\
