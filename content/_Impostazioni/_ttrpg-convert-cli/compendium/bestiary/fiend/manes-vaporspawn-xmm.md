...
- "desc": "Constitution Saving Throw: DC 12, each creature in a 5-foot [Emanation\
    ...
    \ [Incapacitated](rules/conditions.md#Incapacitated) condition until the end of\
    \ its next turn. Success: The target is immune to this manes's Sickening Vapors\
    \ for 24 hours."
  "name": "Sickening Vapors"
"actions":
- "desc": "Melee Attack: dice:1d20+4|noform|text(+4), reach 5 ft. Hit: dice:1d6+2|noform|avg|text(5)\
    \ (1d6 + 2) Slashing damage plus dice:2d4|noform|avg|text(5) (2d4) Necrotic\
    \ damage."
  "name": "Claw"
"bonus_actions":
