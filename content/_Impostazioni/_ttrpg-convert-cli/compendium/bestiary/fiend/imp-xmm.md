...
- "desc": "The imp casts [Invisibility](compendium/spells/invisibility-xphb.md) on\
  ...
  "name": "Invisibility"
- "desc": "The imp has [Advantage](rules/variant-rules/advantage-xphb.md) on saving\
...
- "desc": "Melee Attack: dice:1d20+5|noform|text(+5), reach 5 ft. Hit: dice:1d6+3|noform|avg|text(6)\
    ...
    \ damage."
  "name": "Sting"
- "desc": "The imp shape-shifts to resemble a rat ([Speed](rules/variant-rules/speed-xphb.md)\
    ...
    \ for its [Speed](rules/variant-rules/speed-xphb.md). Any equipment it is wearing\
