...
- "desc": "Melee Attack: dice:1d20+4|noform|text(+4), reach 5 ft. Hit: dice:1d6+2|noform|avg|text(5)\
    \ (1d6 + 2) Piercing damage plus dice:1d6|noform|avg|text(3) (1d6) Fire\
    \ damage."
  "name": "Infernal Fork"
- "desc": "Ranged Attack: dice:1d20+4|noform|text(+4), range 20/80 ft. Hit:\
    \ dice:1d4+2|noform|avg|text(4) (1d4 + 2) Piercing damage plus dice:1d6|noform|avg|text(3)\
    \ (1d6) Fire damage."
  "name": "Tail Spine"
"source":
- "XMM"
