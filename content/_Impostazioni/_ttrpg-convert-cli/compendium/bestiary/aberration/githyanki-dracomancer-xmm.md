...
- "desc": "The githyanki casts one of the following spells, requiring no spell components\
    \ and using Intelligence as the spellcasting ability (spell save DC 18, dice:1d20+10|noform|text(+10)\
...
- "desc": "The githyanki makes three Draconic Strike attacks."
  "name": "Multiattack"
- "desc": "Melee or Ranged Attack: dice:1d20+10|noform|text(+10), reach 10 ft.\
    \ or range 120 ft. Hit: dice:2d6+5|noform|avg|text(12) (2d6 + 5) Slashing\
    \ damage plus dice:5d6|noform|avg|text(17) (5d6) Fire damage, and the target\
...
- "desc": "Dexterity Saving Throw: DC 18, each creature in a 90-foot [Cone [Area\
    \ of Effect]](rules/variant-rules/cone-area-of-effect-xphb.md). Failure: dice:6d8|noform|avg|text(27)\
    \ (6d8) Fire damage plus dice:6d8|noform|avg|text(27) (6d8) Force damage.\
    \ Success: Half damage."
