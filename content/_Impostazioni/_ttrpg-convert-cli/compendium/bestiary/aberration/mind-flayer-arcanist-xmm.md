...
- "desc": "Melee or Ranged Attack: dice:1d20+9|noform|text(+9), reach 5 ft. or\
    \ range 120 ft. Hit: dice:4d10+5|noform|avg|text(27) (4d10 + 5) Psychic\
    \ damage, and the mind flayer can teleport the target up to 30 feet to an unoccupied\
    \ space the mind flayer can see on a surface or liquid large enough to support\
    \ the target. If this damage reduces the target to 0 [Hit Points](rules/variant-rules/hit-points-xphb.md),\
...
- "desc": "Intelligence Saving Throw: DC 17, each creature in a 40-foot [Emanation\
    ...
    \ from the mind flayer. Failure: dice:8d8+5|noform|avg|text(41) (8d8 + 5)\
    \ Psychic damage, and the target has the [Stunned](rules/conditions.md#Stunned)\
