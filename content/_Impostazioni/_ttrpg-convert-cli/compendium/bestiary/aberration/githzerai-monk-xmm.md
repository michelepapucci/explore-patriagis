...
- "desc": "Melee Attack: dice:1d20+4|noform|text(+4), reach 5 ft. Hit: dice:1d8+2|noform|avg|text(6)\
    \ (1d8 + 2) Bludgeoning damage plus dice:2d8|noform|avg|text(9) (2d8) Psychic\
    \ damage."
  "name": "Psi Strike"
"source":
- "XMM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/XMM/Githzerai%20Monk.webp"
```
^statblock
