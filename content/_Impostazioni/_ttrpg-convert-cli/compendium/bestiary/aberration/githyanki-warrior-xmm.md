...
- "desc": "The githyanki casts one of the following spells, requiring no spell components\
    ...
    \ (the hand is Invisible)\n\n2/day: [Nondetection](compendium/spells/nondetection-xphb.md)\
    \ (self only)"
  "name": "Spellcasting"
...
- "desc": "Melee Attack: dice:1d20+4|noform|text(+4), reach 5 ft. Hit: dice:2d6+2|noform|avg|text(9)\
    \ (2d6 + 2) Slashing damage plus dice:2d6|noform|avg|text(7) (2d6) Psychic\
    \ damage."
  "name": "Psi Blade"
"source":
- "XMM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/XMM/Githyanki%20Warrior.webp"
```
^statblock
