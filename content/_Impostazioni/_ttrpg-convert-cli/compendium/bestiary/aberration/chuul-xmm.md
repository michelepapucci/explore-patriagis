...
- "desc": "The chuul makes two Pincer attacks and uses Paralyzing Tentacles."
  "name": "Multiattack"
- "desc": "Melee Attack: dice:1d20+6|noform|text(+6), reach 10 ft. Hit: dice:1d10+4|noform|avg|text(9)\
  ...
  "name": "Pincer"
- "desc": "Constitution Saving Throw: DC 13, one creature [Grappled](rules/conditions.md#Grappled)\
    \ by the chuul. Failure: The target has the [Poisoned](rules/conditions.md#Poisoned)\
