...
---
# [Aberrant Spirit (Star Spawn)](compendium/bestiary/aberration/aberrant-spirit-star-spawn-xphb.md)
...
- "desc": "At the start of each of the spirit's turns, the spirit emits psionic energy\
    \ if it doesn't have the [Incapacitated](rules/conditions.md#Incapacitated) condition.\
    \ Wisdom Saving Throw: DC equals your spell save DC, each creature (other than\
    \ you) within 5 feet of the spirit. Failure: dice:2d6|noform|avg (2d6) Psychic\
    \ damage."
