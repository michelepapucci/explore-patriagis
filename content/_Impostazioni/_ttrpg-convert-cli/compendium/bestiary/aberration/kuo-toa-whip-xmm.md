...
"actions":
- "desc": "Melee Attack: dice:1d20+4|noform|text(+4), reach 10 ft. Hit: dice:2d6+2|noform|avg|text(9)\
    \ (2d6 + 2) Piercing damage. If the target is a Medium or smaller creature,\
  ...
  "name": "Pincer Staff"
- "desc": "Ranged Attack: dice:1d20+4|noform|text(+4), range 60 ft. Hit: dice:3d4+2|noform|avg|text(9)\
    \ (3d4 + 2) Acid damage."
  "name": "Conjure Slimy Glob"
"source":
- "XMM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/XMM/Kuo-toa%20Whip.webp"
```
^statblock
