...
- "desc": "The kuo-toa makes two Bone Whip attacks."
  "name": "Multiattack"
- "desc": "Melee Attack: dice:1d20+5|noform|text(+5), reach 10 ft. Hit: dice:1d6+3|noform|avg|text(6)\
    \ (1d6 + 3) Slashing damage plus dice:2d6|noform|avg|text(7) (2d6) Lightning\
    \ damage, and the target can't make Opportunity Attacks until the start of the\
    \ kuo-toa's next turn."
  "name": "Bone Whip"
"source":
- "XMM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/XMM/Kuo-toa%20Monitor.webp"
```
^statblock
