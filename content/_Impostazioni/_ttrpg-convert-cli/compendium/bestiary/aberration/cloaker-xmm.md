...
- "desc": "The cloaker casts the [Mirror Image](compendium/spells/mirror-image-xphb.md)\
    ...
    \ The spell ends early if the cloaker starts or ends its turn in [Bright Light](rules/variant-rules/bright-light-xphb.md).\n\
    \nAt will: [Mirror Image](compendium/spells/mirror-image-xphb.md)"
  "name": "Phantasms (Recharge after a Short or Long Rest)"
- "desc": "While in [Bright Light](rules/variant-rules/bright-light-xphb.md), the\
    \ cloaker has [Disadvantage](rules/variant-rules/disadvantage-xphb.md) on attack\
    \ rolls."
...
- "desc": "Melee Attack: dice:1d20+6|noform|text(+6), reach 5 ft. Hit: dice:3d6+3|noform|avg|text(13)\
    \ (3d6 + 3) Piercing damage. If the target is a Large or smaller creature, the\
    \ cloaker attaches to it. While the cloaker is attached, the target has the [Blinded](rules/conditions.md#Blinded)\
    ...
    \ ([Athletics](rules/skills.md#Athletics)) check."
  "name": "Attach"
- "desc": "Melee Attack: dice:1d20+6|noform|text(+6), reach 10 ft. Hit: dice:1d10+3|noform|avg|text(8)\
...
- "desc": "Wisdom Saving Throw: DC 13, each creature in a 60-foot [Emanation [Area\
    ...
    \ from the cloaker. Failure: The target has the [Frightened](rules/conditions.md#Frightened)\
