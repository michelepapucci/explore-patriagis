...
- "desc": "The roper makes two Tentacle attacks, uses Reel, and makes two Bite attacks."
  "name": "Multiattack"
- "desc": "Melee Attack: dice:1d20+7|noform|text(+7), reach 5 ft. Hit: dice:3d8+4|noform|avg|text(17)\
    \ (3d8 + 4) Piercing damage."
  "name": "Bite"
- "desc": "Melee Attack: dice:1d20+7|noform|text(+7), reach 60 ft. Hit: The\
    \ target has the [Grappled](rules/conditions.md#Grappled) condition (escape DC\
    \ 14) from one of six tentacles, and the target has the [Poisoned](rules/conditions.md#Poisoned)\
    \ condition until the grapple ends.\n\nThe tentacle can be damaged, freeing a\
    \ creature it has [Grappled](rules/conditions.md#Grappled) when destroyed (AC\
    \ 20, HP 10, [Immunity](rules/variant-rules/immunity-xphb.md) to Poison and Psychic\
    \ damage). Damaging the tentacle deals no damage to the roper, and a destroyed\
    \ tentacle regrows at the start of the roper's next turn."
  "name": "Tentacle"
