...
"skillsaves":
  "Perception": !!int "6"
"condition_immunities": "[exhaustion](rules/conditions.md#Exhaustion), [prone](rules/conditions.md#Prone)"
...
- "desc": "The spectator randomly shoots one of the following magical rays at a target\
    \ it can see within 90 feet of itself (roll dice:1d4|noform|avg (1d4); reroll\
    \ if the spectator has already used that ray during this turn):\n\n- 1 Confusion\
    \ Ray. Wisdom Saving Throw: DC 12. Failure: dice:2d4|noform|avg|text(5)\
    \ (2d4) Psychic damage, and the target can't take Reactions until the end of\
    \ its next turn. On its next turn, the target can't move, and it uses its action\
    \ to make a melee or ranged attack against a randomly determined creature within\
    \ range. If the target can't attack, it does nothing on that turn.  \n- 2 Paralyzing\
    \ Ray. Constitution Saving Throw: DC 12. Failure: The target has the [Paralyzed](rules/conditions.md#Paralyzed)\
    \ condition and repeats the save at the end of each of its turns, ending the effect\
    \ on itself on a success. After 1 minute, it succeeds automatically.  \n- 3\
    \ Fear Ray. Wisdom Saving Throw: DC 12. Failure: dice:2d4|noform|avg|text(5)\
    \ (2d4) Psychic damage, and the target has the [Frightened](rules/conditions.md#Frightened)\
    \ condition until the end of its next turn.  \n- 4 Wounding Ray. Constitution\
    \ Saving Throw: DC 12. Failure: dice:3d10|noform|avg|text(16) (3d10) Necrotic\
...
- "desc": "Trigger: The spectator succeeds on a saving throw against a spell, or a\
    ...
    \ 12, one creature the spectator can see within 120 feet. Failure: dice:3d6|noform|avg|text(10)\
    \ (3d6) Force damage."
