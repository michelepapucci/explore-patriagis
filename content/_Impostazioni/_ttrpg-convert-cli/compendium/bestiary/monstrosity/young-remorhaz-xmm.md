...
- "desc": "At the end of each of the remorhaz's turns, each creature in a 5-foot [Emanation\
    ...
    \ from the remorhaz takes dice:2d10|noform|avg|text(11) (2d10) Fire damage."
  "name": "Heat Aura"
"actions":
- "desc": "Melee Attack: dice:1d20+7|noform|text(+7), reach 5 ft. Hit: dice:2d10+4|noform|avg|text(15)\
    \ (2d10 + 4) Piercing damage plus dice:3d8|noform|avg|text(13) (3d8) Fire\
    \ damage."
  "name": "Bite"
"source":
- "XMM"
