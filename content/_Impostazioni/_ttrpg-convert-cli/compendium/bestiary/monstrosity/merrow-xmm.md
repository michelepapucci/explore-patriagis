...
- "desc": "Melee Attack: dice:1d20+6|noform|text(+6), reach 5 ft. Hit: dice:1d4+4|noform|avg|text(6)\
    \ (1d4 + 4) Piercing damage, and the target has the [Poisoned](rules/conditions.md#Poisoned)\
...
- "desc": "Melee or Ranged Attack: dice:1d20+6|noform|text(+6), reach 5 ft. or\
    \ range 20/60 ft. Hit: dice:2d6+4|noform|avg|text(11) (2d6 + 4) Piercing\
    \ damage. If the target is a Large or smaller creature, the merrow pulls the target\
    \ up to 15 feet straight toward itself."
  "name": "Harpoon"
"source":
- "XMM"
