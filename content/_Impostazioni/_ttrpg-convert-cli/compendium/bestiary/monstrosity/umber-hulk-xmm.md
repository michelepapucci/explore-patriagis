...
"cr": "5"
"traits":
- "desc": "The umber hulk can burrow through solid rock at half its [Burrow Speed](rules/variant-rules/burrow-speed-xphb.md)\
...
- "desc": "Wisdom Saving Throw: DC 14, each creature in a 30-foot [Cone [Area of\
    ...
    \ can't take Reactions until the start of the umber hulk's next turn, and the\
    \ target rolls dice:1d8|noform|avg (1d8) to determine what it does on its\
    \ next turn:\n\n- 1-4. The target does nothing.  \n- 5-6. The target takes\
    \ no action or [Bonus Action](rules/variant-rules/bonus-action-xphb.md) and uses\
...
"source":
- "XMM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/XMM/Umber%20Hulk.webp"
```
^statblock
