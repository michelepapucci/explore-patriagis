...
- "desc": "Melee Attack: dice:1d20+7|noform|text(+7), reach 5 ft. Hit: dice:2d12+4|noform|avg|text(17)\
    \ (2d12 + 4) Piercing damage. If the target is a Humanoid, it is subjected to\
    ...
    \ it instead becomes a Werebear under the DM's control and has 10 [Hit Points](rules/variant-rules/hit-points-xphb.md).\
...
- "desc": "Melee or Ranged Attack: dice:1d20+7|noform|text(+7), reach 5 ft or\
    \ range 20/60 ft. Hit: dice:3d6+4|noform|avg|text(14) (3d6 + 4) Slashing\
    \ damage."
