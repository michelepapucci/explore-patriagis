...
- "desc": "Melee Attack: dice:1d20+5|noform|text(+5), reach 5 ft. Hit: dice:1d4+3|noform|avg|text(5)\
    \ (1d4 + 3) Piercing damage plus dice:2d6|noform|avg|text(7) (2d6) Poison\
    \ damage."
  "name": "Bite"
- "desc": "Ranged Attack: dice:1d20+5|noform|text(+5), range 120 ft. Hit: dice:2d8+3|noform|avg|text(12)\
    \ (2d8 + 3) Poison damage."
...
"source":
- "XMM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/XMM/Yuan-ti%20Malison%20%28Type%201%29.webp"
```
^statblock
