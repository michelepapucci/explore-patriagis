...
- "desc": "The doppelganger makes two Slam attacks and uses Unsettling Visage if available."
  "name": "Multiattack"
- "desc": "Melee Attack: dice:1d20+6|noform|text(+6) (with [Advantage](rules/variant-rules/advantage-xphb.md)\
    \ during the first round of each combat), reach 5 ft. Hit: dice:2d6+4|noform|avg|text(11)\
...
- "desc": "Wisdom Saving Throw: DC 12, each creature in a 15-foot [Emanation [Area\
    ...
    \ from the doppelganger that can see the doppelganger. Failure: The target has\
    \ the [Frightened](rules/conditions.md#Frightened) condition and repeats the save\
    \ at the end of each of its turns, ending the effect on itself on a success. After\
