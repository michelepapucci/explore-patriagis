...
- "desc": "Melee Attack: dice:1d20+5|noform|text(+5), reach 5 ft. Hit: dice:1d8+3|noform|avg|text(7)\
    \ (1d8 + 3) Piercing damage. If the peryton moved 30+ feet straight toward the\
    \ target immediately before the hit, the target takes an extra dice:2d8|noform|avg|text(9)\
    \ (2d8) Piercing damage."
  "name": "Gore"
- "desc": "Melee Attack: dice:1d20+5|noform|text(+5), reach 5 ft. Hit: dice:2d4+3|noform|avg|text(8)\
    \ (2d4 + 3) Piercing damage. If the attack reduces a Humanoid target to 0 [Hit\
    \ Points](rules/variant-rules/hit-points-xphb.md), the peryton kills the target\
    \ by removing its heart."
  "name": "Talons"
"source":
- "XMM"
