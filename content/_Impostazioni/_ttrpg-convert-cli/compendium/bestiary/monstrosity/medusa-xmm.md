...
- "desc": "Melee Attack: dice:1d20+6|noform|text(+6), reach 5 ft. Hit: dice:2d6+3|noform|avg|text(10)\
  ...
  "name": "Claw"
- "desc": "Melee Attack: dice:1d20+6|noform|text(+6), reach 5 ft. Hit: dice:1d4+3|noform|avg|text(5)\
    \ (1d4 + 3) Piercing damage plus dice:4d6|noform|avg|text(14) (4d6) Poison\
    \ damage."
  "name": "Snake Hair"
- "desc": "Ranged Attack: dice:1d20+5|noform|text(+5), range 150 ft. Hit: dice:2d8+2|noform|avg|text(11)\
    \ (2d8 + 2) Poison damage."
  "name": "Poison Ray"
"bonus_actions":
- "desc": "Constitution Saving Throw: DC 13, each creature in a 30-foot [Cone [Area\
    \ of Effect]](rules/variant-rules/cone-area-of-effect-xphb.md). If the medusa\
    \ sees its reflection in the [Cone [Area of Effect]](rules/variant-rules/cone-area-of-effect-xphb.md),\
    \ the medusa must make this save. {@actSaveFail 1} The target has the [Restrained](rules/conditions.md#Restrained)\
