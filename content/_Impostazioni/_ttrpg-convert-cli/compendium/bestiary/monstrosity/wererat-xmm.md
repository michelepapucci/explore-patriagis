...
- "desc": "The wererat makes two attacks, using Scratch or Hand Crossbow in any combination.\
  ...
  "name": "Multiattack"
- "desc": "Melee Attack: dice:1d20+5|noform|text(+5), reach 5 ft. Hit: dice:2d4+3|noform|avg|text(8)\
    \ (2d4 + 3) Piercing damage. If the target is a Humanoid, it is subjected to\
    \ the following effect. Constitution Saving Throw: DC 11. Failure: The target\
    \ is cursed. If the cursed target drops to 0 [Hit Points](rules/variant-rules/hit-points-xphb.md),\
    \ it instead becomes a Wererat under the DM's control and has 10 [Hit Points](rules/variant-rules/hit-points-xphb.md).\
...
- "desc": "Ranged Attack: dice:1d20+5|noform|text(+5), range 30/120 ft. Hit:\
    \ dice:1d6+3|noform|avg|text(6) (1d6 + 3) Piercing damage."
