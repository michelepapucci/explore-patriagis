...
- "desc": "Melee Attack: dice:1d20+5|noform|text(+5), reach 5 ft. Hit: dice:2d8+3|noform|avg|text(12)\
    ...
    \ the following effect. Constitution Saving Throw: DC 13. Failure: The target\
    \ is cursed. If the cursed target drops to 0 [Hit Points](rules/variant-rules/hit-points-xphb.md),\
    \ it instead becomes a Weretiger under the DM's control and has 10 [Hit Points](rules/variant-rules/hit-points-xphb.md).\
...
- "desc": "Ranged Attack: dice:1d20+4|noform|text(+4), range 150/600 ft. Hit:\
    \ dice:2d8+2|noform|avg|text(11) (2d8 + 2) Piercing damage."
  "name": "Longbow (Humanoid or Hybrid Form Only)"
"bonus_actions":
- "desc": "The weretiger moves up to its [Speed](rules/variant-rules/speed-xphb.md)\
