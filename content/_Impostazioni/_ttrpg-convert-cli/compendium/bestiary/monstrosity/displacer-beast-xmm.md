...
- "desc": "If the displacer beast is subjected to an effect that allows it to make\
  ...
  "name": "Avoidance"
- "desc": "Attack rolls against the displacer beast have [Disadvantage](rules/variant-rules/disadvantage-xphb.md),\
    \ since it projects an illusion that makes it appear to be near its actual location.\
    \ This trait is suppressed while the displacer beast has the [Incapacitated](rules/conditions.md#Incapacitated)\
    \ condition."
  "name": "Displacement"
"actions":
- "desc": "The displacer beast makes one Rend attack and one Tentacle attack."
  "name": "Multiattack"
- "desc": "Melee Attack: dice:1d20+6|noform|text(+6), reach 5 feet. Hit: dice:1d10+4|noform|avg|text(9)\
    \ (1d10 + 4) Slashing damage. If target is a Large or smaller creature, it has\
    \ the [Prone](rules/conditions.md#Prone) condition."
  "name": "Rend"
- "desc": "Melee Attack: dice:1d20+6|noform|text(+6), reach 10 feet. Hit: dice:2d6+4|noform|avg|text(11)\
