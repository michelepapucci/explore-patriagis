...
"cr": "3"
"actions":
- "desc": "Melee Attack: dice:1d20+6|noform|text(+6), reach 10 ft. Hit: dice:1d12+4|noform|avg|text(10)\
    \ (1d12 + 4) Slashing damage plus dice:3d6|noform|avg|text(10) (3d6) Necrotic\
    \ damage."
  "name": "Abyssal Glaive"
- "desc": "Melee Attack: dice:1d20+6|noform|text(+6), reach 5 ft. Hit: dice:4d6+4|noform|avg|text(18)\
    \ (4d6 + 4) Piercing damage. If the target is a Large or smaller creature and\
    \ the minotaur moved 10+ feet straight toward it immediately before the hit, the\
    \ target takes an extra dice:3d6|noform|avg|text(10) (3d6) Piercing damage\
