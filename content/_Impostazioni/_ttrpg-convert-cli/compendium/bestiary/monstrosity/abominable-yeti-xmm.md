...
"cr": "9"
"traits":
- "desc": "If the yeti takes Fire damage, it has [Disadvantage](rules/variant-rules/disadvantage-xphb.md)\
...
- "desc": "The yeti can use its Chilling Gaze and makes two attacks, using Claw or\
  ...
  "name": "Multiattack"
- "desc": "Melee Attack: dice:1d20+11|noform|text(+11), reach 5 ft. Hit: dice:2d6+7|noform|avg|text(14)\
    \ (2d6 + 7) Slashing damage plus dice:2d6|noform|avg|text(7) (2d6) Cold\
    \ damage."
  "name": "Claw"
- "desc": "Ranged Attack: dice:1d20+11|noform|text(+11), range 60/240 ft. Hit:\
    \ dice:2d4+7|noform|avg|text(12) (2d4 + 7) Bludgeoning damage plus dice:2d6|noform|avg|text(7)\
    \ (2d6) Cold damage."
  "name": "Ice Throw"
- "desc": "Constitution Saving Throw: DC 18, one creature the yeti can see within\
    \ 30 feet. Failure: dice:6d6|noform|avg|text(21) (6d6) Cold damage, and\
    \ the target has the [Paralyzed](rules/conditions.md#Paralyzed) condition until\
    \ the start of the yeti's next turn unless the target has [Immunity](rules/variant-rules/immunity-xphb.md)\
...
- "desc": "Constitution Saving Throw: DC 18, each creature in a 30-foot [Cone [Area\
    \ of Effect]](rules/variant-rules/cone-area-of-effect-xphb.md). Failure: dice:10d8|noform|avg|text(45)\
    \ (10d8) Cold damage. Success: Half damage."
  "name": "Cold Breath (Recharge 6)"
"source":
- "XMM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/XMM/Abominable%20Yeti.webp"
```
^statblock
