...
- "desc": "Melee Attack: dice:1d20+5|noform|text(+5), reach 5 ft. Hit: dice:2d8+3|noform|avg|text(12)\
    \ (2d8 + 3) Piercing damage. If the target is a Humanoid, it is subjected to\
    \ the following effect. Constitution Saving Throw: DC 12. Failure: The target\
    \ is cursed. If the cursed target drops to 0 [Hit Points](rules/variant-rules/hit-points-xphb.md),\
    \ it instead becomes a Wereboar under the DM's control and has 10 [Hit Points](rules/variant-rules/hit-points-xphb.md).\
...
- "desc": "Melee or Ranged Attack: dice:1d20+5|noform|text(+5), reach 5 ft. or\
    \ range 30/120 ft. Hit: dice:3d6+3|noform|avg|text(13) (3d6 + 3) Piercing\
    \ damage."
...
- "desc": "Melee Attack: dice:1d20+5|noform|text(+5), reach 5 ft. Hit: dice:2d6+3|noform|avg|text(10)\
    \ (2d6 + 3) Piercing damage. If the target is a Medium or smaller creature and\
    \ the wereboar moved 20+ feet straight toward it immediately before the hit, the\
    \ target takes an extra dice:2d6|noform|avg|text(7) (2d6) Piercing damage\
