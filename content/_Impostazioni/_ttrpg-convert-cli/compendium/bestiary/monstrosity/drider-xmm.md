...
- "desc": "The drider can climb difficult surfaces, including along ceilings, without\
  ...
  "name": "Spider Climb"
- "desc": "While in sunlight, the drider has [Disadvantage](rules/variant-rules/disadvantage-xphb.md)\
...
- "desc": "The drider makes three attacks, using Foreleg or Poison Burst in any combination."
  "name": "Multiattack"
- "desc": "Melee Attack: dice:1d20+7|noform|text(+7), reach 10 ft. Hit: dice:2d8+4|noform|avg|text(13)\
    \ (2d8 + 4) Piercing damage."
  "name": "Foreleg"
- "desc": "Ranged Attack: dice:1d20+6|noform|text(+6), range 120 ft. Hit: dice:3d6+3|noform|avg|text(13)\
    \ (3d6 + 3) Poison damage."
  "name": "Poison Burst"
"source":
- "XMM"
