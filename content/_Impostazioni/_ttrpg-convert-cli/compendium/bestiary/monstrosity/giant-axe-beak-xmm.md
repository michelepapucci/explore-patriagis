...
- "desc": "The axe beak makes one Sharpened Beak attack and one Talons attack."
  "name": "Multiattack"
- "desc": "Melee Attack: dice:1d20+8|noform|text(+8), reach 10 ft. Hit: dice:2d12+5|noform|avg|text(18)\
    \ (2d12 + 5) Slashing damage, and a creature within 5 feet of the target (axe\
    \ beak's choice) takes dice:1d12|noform|avg|text(6) (1d12) Slashing damage."
  "name": "Sharpened Beak"
- "desc": "Melee Attack: dice:1d20+8|noform|text(+8), reach 5 ft. Hit: dice:2d8+5|noform|avg|text(14)\
    \ (2d8 + 5) Piercing damage. If the target is a Large or smaller creature, it\
    \ has the [Prone](rules/conditions.md#Prone) condition."
  "name": "Talons"
"source":
- "XMM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/XMM/Giant%20Axe%20Beak.webp"
```
^statblock
