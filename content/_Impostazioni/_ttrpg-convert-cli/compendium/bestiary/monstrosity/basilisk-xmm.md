...
- "desc": "Melee Attack: dice:1d20+5|noform|text(+5), reach 5 ft. Hit: dice:2d6+3|noform|avg|text(10)\
    \ (2d6 + 3) Piercing damage plus dice:2d6|noform|avg|text(7) (2d6) Poison\
    \ damage."
  "name": "Bite"
"bonus_actions":
- "desc": "Constitution Saving Throw: DC 12, each creature in a 30-foot [Cone [Area\
    \ of Effect]](rules/variant-rules/cone-area-of-effect-xphb.md). If the basilisk\
    \ sees its reflection within the [Cone [Area of Effect]](rules/variant-rules/cone-area-of-effect-xphb.md),\
    \ the basilisk must make this save. {@actSaveFail 1} The target has the [Restrained](rules/conditions.md#Restrained)\
