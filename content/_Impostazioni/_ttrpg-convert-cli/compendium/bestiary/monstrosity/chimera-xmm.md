...
- "desc": "Melee Attack: dice:1d20+7|noform|text(+7), reach 5 ft. Hit: dice:2d6+4|noform|avg|text(11)\
    \ (2d6 + 4) Piercing damage, or dice:4d6+4|noform|avg|text(18) (4d6 + 4)\
    \ Piercing damage if the chimera had [Advantage](rules/variant-rules/advantage-xphb.md)\
    \ on the attack roll."
  "name": "Bite"
...
- "desc": "Melee Attack: dice:1d20+7|noform|text(+7), reach 5 ft. Hit: dice:1d12+4|noform|avg|text(10)\
    \ (1d12 + 4) Bludgeoning damage. If the target is a Medium or smaller creature,\
...
- "desc": "Dexterity Saving Throw: DC 15, each creature in a 15-foot [Cone [Area\
    \ of Effect]](rules/variant-rules/cone-area-of-effect-xphb.md). Failure: dice:7d8|noform|avg|text(31)\
