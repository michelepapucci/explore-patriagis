...
---
# [Giant Insect (Centipede)](compendium/bestiary/beast/giant-insect-centipede-xphb.md)
...
- "desc": "Melee Attack: YourSpellAttack Bonus equals your spell attack modifier,\
    \ reach 10 ft. Hit: 1d6 + 3 + the spell's level Piercing damage plus dice:1d4|noform|avg\
    \ (1d4) Poison damage."
  "name": "Poison Jab"
"bonus_actions":
- "desc": "Constitution Saving Throw: Your spell save DC, one creature the insect\
    \ can see within 10 feet. Failure: The target has the [Poisoned](rules/conditions.md#Poisoned)\
