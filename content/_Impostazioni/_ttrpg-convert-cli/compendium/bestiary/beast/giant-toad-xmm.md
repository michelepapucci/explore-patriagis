...
- "desc": "The toad can breathe air and water."
  "name": "Amphibious"
- "desc": "The toad's [Long Jump](rules/variant-rules/long-jump-xphb.md) is up to\
...
- "desc": "Melee Attack: dice:1d20+4|noform|text(+4), reach 5 ft. Hit: dice:1d6+2|noform|avg|text(5)\
    \ (1d6 + 2) Piercing damage plus dice:2d4|noform|avg|text(5) (2d4) Poison\
...
- "desc": "The toad swallows a Medium or smaller target it is grappling. While swallowed,\
    ...
    \ takes dice:3d6|noform|avg|text(10) (3d6) Acid damage at the end of each\
    \ of the toad's turns. The toad can have only one target swallowed at a time,\
    \ and it can't use Bite while it has a swallowed target. If the toad dies, a swallowed\
    \ creature is no longer [Restrained](rules/conditions.md#Restrained) and can escape\
    \ from the corpse using 5 feet of movement, exiting with the [Prone](rules/conditions.md#Prone)\
    \ condition."
  "name": "Swallow"
"source":
- "XMM"
