...
- "desc": "The naga casts one of the following spells, requiring no Material components\
    ...
    \ will: [Mage Hand](compendium/spells/mage-hand-xphb.md), [Thaumaturgy](compendium/spells/thaumaturgy-xphb.md)\n\
...
- "desc": "Melee Attack: dice:1d20+5|noform|text(+5), reach 10 ft. Hit: dice:2d6+3|noform|avg|text(10)\
    \ (2d6 + 3) Piercing damage plus dice:2d6|noform|avg|text(7) (2d6) Necrotic\
    \ damage."
  "name": "Bite"
- "desc": "Wisdom Saving Throw: DC 13, one creature the naga can see within 60 feet.\
    \ Failure: dice:3d6+3|noform|avg|text(13) (3d6 + 3) Psychic damage, and\
    \ the target has the [Charmed](rules/conditions.md#Charmed) condition until the\
    \ start of the naga's next turn."
