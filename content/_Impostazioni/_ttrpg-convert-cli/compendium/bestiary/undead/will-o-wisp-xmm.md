...
- "desc": "The wisp can't wear or carry anything."
  "name": "Ephemeral"
- "desc": "The wisp sheds [Bright Light](rules/variant-rules/bright-light-xphb.md)\
    \ in a 20-foot radius and [Dim Light](rules/variant-rules/dim-light-xphb.md) for\
    \ an additional 20 feet."
  "name": "Illumination"
- "desc": "The wisp can move through other creatures and objects as if they were [Difficult\
    \ Terrain](rules/variant-rules/difficult-terrain-xphb.md). It takes dice:1d10|noform|avg|text(5)\
    \ (1d10) Force damage if it ends its turn inside an object."
  "name": "Incorporeal Movement"
"actions":
- "desc": "Melee Attack: dice:1d20+4|noform|text(+4), reach 5 ft. Hit: dice:2d8+2|noform|avg|text(11)\
    \ (2d8 + 2) Lightning damage."
  "name": "Shock"
"bonus_actions":
- "desc": "Constitution Saving Throw: DC 10, one living creature the wisp can see\
    \ within 5 feet that has 0 [Hit Points](rules/variant-rules/hit-points-xphb.md).\
    \ Failure: The target dies, and the wisp regains dice:3d6|noform|avg|text(10)\
    \ (3d6) [Hit Points](rules/variant-rules/hit-points-xphb.md)."
  "name": "Consume Life"
- "desc": "The wisp and its light have the [Invisible](rules/conditions.md#Invisible)\
    \ condition until the wisp's [Concentration](rules/conditions.md#Concentration)\
