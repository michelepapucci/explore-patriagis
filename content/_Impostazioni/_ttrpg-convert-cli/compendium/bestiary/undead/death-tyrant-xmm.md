...
- "desc": "The death tyrant uses Eye Rays three times."
  "name": "Multiattack"
- "desc": "Melee Attack: dice:1d20+9|noform|text(+9), reach 5 feet. Hit: dice:2d8+4|noform|avg|text(13)\
    \ (2d8 + 4) Piercing damage."
  "name": "Bite"
- "desc": "The death tyrant randomly shoots one of the following magical rays at a\
    \ target it can see within 120 feet of itself (roll dice:1d10|noform|avg (1d10);\
    \ reroll if the death tyrant has already used that ray during this turn):\n\n\
    - 1 Charm Ray. Wisdom Saving Throw: DC 17. Failure: dice:3d8|noform|avg|text(13)\
    ...
    \  \n- 2 Paralyzing Ray. Constitution Saving Throw: DC 17. Failure: The\
    ...
    \ Throw: DC 17. Failure: dice:3d6|noform|avg|text(10) (3d6) Psychic damage,\
    ...
    \ Ray. Constitution Saving Throw: DC 17. Failure: dice:4d8|noform|avg|text(18)\
    \ (4d8) Necrotic damage. Until the end of the target's next turn, the target\
    \ can't take Reactions; its [Speed](rules/variant-rules/speed-xphb.md) is halved;\
    \ and it can take either an action or a [Bonus Action](rules/variant-rules/bonus-action-xphb.md)\
    \ on its turn, not both. Success: Half damage only.  \n- 5 Enervation Ray.\
    \ Constitution Saving Throw: DC 17. Failure: dice:3d10|noform|avg|text(16)\
    \ (3d10) Poison damage, and the target has the [Poisoned](rules/conditions.md#Poisoned)\
    ...
    \ the [Restrained](rules/conditions.md#Restrained) condition until the start of\
    \ the death tyrant's next turn or until the death tyrant has the [Incapacitated](rules/conditions.md#Incapacitated)\
    ...
    \ Ray. Wisdom Saving Throw: DC 17 (the target succeeds automatically if it\
    \ is a Construct or an Undead). Failure: The target has the [Unconscious](rules/conditions.md#Unconscious)\
    ...
    \ Constitution Saving Throw: DC 17. {@actSaveFail 1} The target has the [Restrained](rules/conditions.md#Restrained)\
    ...
    \ DC 17. Failure: dice:10d10|noform|avg|text(55) (10d10) Necrotic damage.\
...
- "desc": "The death tyrant's central eye emits an imperceptible, magical wave of\
    \ negative energy in a 150-foot [Cone [Area of Effect]](rules/variant-rules/cone-area-of-effect-xphb.md).\
    \ Creatures in that area can't regain [Hit Points](rules/variant-rules/hit-points-xphb.md)\
    \ until the start of the death tyrant's next turn. An intact Humanoid corpse there\
    \ instantly rises as a [Zombie](compendium/bestiary/undead/zombie-xmm.md) under\
...
- "desc": "- Negative Energy Suffusion. Whenever a creature within 1 mile of the\
    \ lair regains [Hit Points](rules/variant-rules/hit-points-xphb.md) from a spell,\
    \ it subtracts dice:1d10|noform|avg (1d10) from the number of [Hit Points](rules/variant-rules/hit-points-xphb.md)\
    ...
    \ that finishes a [Short Rest](rules/variant-rules/short-rest-xphb.md) while within\
    \ 1 mile of the lair must succeed on a DC 15 Wisdom saving throw or gain no benefit\
    \ from that rest.  "
  "name": ""
