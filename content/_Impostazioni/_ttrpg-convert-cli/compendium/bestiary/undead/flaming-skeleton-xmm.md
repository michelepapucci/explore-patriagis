...
- "desc": "The skeleton explodes when it dies. Dexterity Saving Throw: DC 12, each\
    \ creature in a 10-foot [Emanation [Area of Effect]](rules/variant-rules/emanation-area-of-effect-xphb.md)\
    \ originating from the skeleton. Failure: dice:4d6|noform|avg|text(14) (4d6)\
    \ Fire damage. Success: Half damage."
  "name": "Death Burst"
- "desc": "The skeleton sheds [Bright Light](rules/variant-rules/bright-light-xphb.md)\
...
- "desc": "Melee Attack: dice:1d20+4|noform|text(+4), reach 5 ft. Hit: dice:1d6+2|noform|avg|text(5)\
    \ (1d6 + 2) Bludgeoning damage plus dice:1d6|noform|avg|text(3) (1d6) Fire\
    \ damage."
  "name": "Flame Scepter"
- "desc": "Ranged Attack: dice:1d20+4|noform|text(+4), range 60 ft. Hit: dice:1d10+2|noform|avg|text(7)\
    \ (1d10 + 2) Fire damage."
  "name": "Hurl Flame"
"source":
- "XMM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/XMM/Flaming%20Skeleton.webp"
```
^statblock
