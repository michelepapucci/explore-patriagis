...
- "desc": "If the revenant dies, it revives 24 hours later unless [Dispel Evil and\
    ...
    \ with all its [Hit Points](rules/variant-rules/hit-points-xphb.md)."
  "name": "Undead Restoration"
"actions":
- "desc": "The revenant makes two Suffocate attacks."
  "name": "Multiattack"
- "desc": "Melee Attack: dice:1d20+8|noform|text(+8), reach 10 ft. Hit: dice:1d10+5|noform|avg|text(10)\
    \ (1d10 + 5) Bludgeoning damage plus dice:3d6|noform|avg|text(10) (3d6)\
    \ Necrotic damage. If the target is a Large or smaller creature, it has the [Grappled](rules/conditions.md#Grappled)\
    \ condition (escape DC 15). Until the grapple ends, the target is suffocating.\
    \ The revenant can have up to two targets [Grappled](rules/conditions.md#Grappled)\
...
- "desc": "Wisdom Saving Throw: DC 15, each creature in a 30-foot [Emanation [Area\
    ...
    \ from the revenant. Failure: The target has the [Paralyzed](rules/conditions.md#Paralyzed)\
