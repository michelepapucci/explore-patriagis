...
- "desc": "While in sunlight, the wraith has [Disadvantage](rules/variant-rules/disadvantage-xphb.md)\
    \ on ability checks and attack rolls."
  "name": "Sunlight Sensitivity"
"actions":
- "desc": "Melee Attack: dice:1d20+6|noform|text(+6), reach 5 ft. Hit: dice:4d8+3|noform|avg|text(21)\
    \ (4d8 + 3) Necrotic damage. If the target is a creature, its [Hit Points](rules/variant-rules/hit-points-xphb.md)\
