...
- "desc": "The mummy casts one of the following spells, requiring no Material components\
    \ and using Wisdom as the spellcasting ability (spell save DC 17, dice:1d20+9|noform|text(+9)\
  ...
  "name": "Spellcasting"
- "desc": "The mummy casts [Command](compendium/spells/command-xphb.md) (level 2 version),\
    \ using the same spellcasting ability as Spellcasting. The mummy can't take this\
...
- "desc": "The mummy has [Advantage](rules/variant-rules/advantage-xphb.md) on saving\
    \ throws against spells and other magical effects."
  "name": "Magic Resistance"
- "desc": "If destroyed, the mummy gains a new body in 24 hours if its heart is intact,\
    \ reviving with all its [Hit Points](rules/variant-rules/hit-points-xphb.md).\
    \ The new body appears in an unoccupied space within the mummy's lair. The heart\
    \ is a Tiny object that has AC 17, HP 10, and [Immunity](rules/variant-rules/immunity-xphb.md)\
...
- "desc": "The mummy makes one Rotting Fist or Channel Negative Energy attack, and\
  ...
  "name": "Multiattack"
- "desc": "Melee Attack: dice:1d20+9|noform|text(+9), reach 5 ft. Hit: dice:2d10+4|noform|avg|text(15)\
    \ (2d10 + 4) Bludgeoning damage plus dice:3d6|noform|avg|text(10) (3d6)\
    \ Necrotic damage. If the target is a creature, it is cursed. While cursed, the\
    \ target can't regain [Hit Points](rules/variant-rules/hit-points-xphb.md), it\
    \ gains no benefit from finishing a [Long Rest](rules/variant-rules/long-rest-xphb.md),\
    \ and its [Hit Points](rules/variant-rules/hit-points-xphb.md) maximum decreases\
    \ by dice:3d6|noform|avg|text(10) (3d6) every 24 hours that elapse. A creature\
    \ dies and turns to dust if reduced to 0 [Hit Points](rules/variant-rules/hit-points-xphb.md)\
    \ by this attack."
  "name": "Rotting Fist"
- "desc": "Ranged Attack: dice:1d20+9|noform|text(+9), range 60 ft. Hit: dice:6d6+4|noform|avg|text(25)\
    \ (6d6 + 4) Necrotic damage."
  "name": "Channel Negative Energy"
- "desc": "Wisdom Saving Throw: DC 17, one creature the mummy can see within 60\
    \ feet. Failure: dice:6d6+4|noform|avg|text(25) (6d6 + 4) Psychic damage,\
    \ and the target has the [Paralyzed](rules/conditions.md#Paralyzed) condition\
    \ until the end of the mummy's next turn."
  "name": "Dreadful Glare"
"reactions":
- "desc": "Trigger: The mummy is hit by an attack roll. Response: The mummy adds 2\
    ...
    \ its choice that it can see within 5 feet of its destination space has the [Blinded](rules/conditions.md#Blinded)\
...
- "desc": "- Cursed Fate. Whenever a creature other than the mummy or one of its\
    ...
    \ with no effect, and the action, [Bonus Action](rules/variant-rules/bonus-action-xphb.md),\
    \ or [Reaction](rules/variant-rules/reaction-xphb.md) used to cast the spell is\
    \ wasted, but any resources used to cast it aren't expended.  \n- Soul Drain.\
    \ Creatures within 1 mile of the lair have [Disadvantage](rules/variant-rules/disadvantage-xphb.md)\
