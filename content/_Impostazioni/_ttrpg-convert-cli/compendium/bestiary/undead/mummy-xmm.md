...
- "desc": "Melee Attack: dice:1d20+5|noform|text(+5), reach 5 ft. Hit: dice:1d10+3|noform|avg|text(8)\
    \ (1d10 + 3) Bludgeoning damage plus dice:3d6|noform|avg|text(10) (3d6)\
    \ Necrotic damage. If the target is a creature, it is cursed. While cursed, the\
    \ target can't regain [Hit Points](rules/variant-rules/hit-points-xphb.md), its\
    \ [Hit Points](rules/variant-rules/hit-points-xphb.md) maximum doesn't return\
    \ to normal when finishing a [Long Rest](rules/variant-rules/long-rest-xphb.md),\
...
- "desc": "Wisdom Saving Throw: DC 11, one creature the mummy can see within 60\
    \ feet. Failure: The target has the [Frightened](rules/conditions.md#Frightened)\
