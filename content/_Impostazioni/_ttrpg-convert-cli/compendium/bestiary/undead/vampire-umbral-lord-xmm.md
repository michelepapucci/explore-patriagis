...
"cr": "15"
"traits":
- "desc": "The vampire casts [Hunger of Hadar](compendium/spells/hunger-of-hadar-xphb.md)\
...
- "desc": "If the vampire drops to 0 [Hit Points](rules/variant-rules/hit-points-xphb.md)\
    ...
    \ its resting place, it has the [Paralyzed](rules/conditions.md#Paralyzed) condition\
    \ for 1 hour, after which it regains 1 [Hit Points](rules/variant-rules/hit-points-xphb.md)."
  "name": "Shadow Escape"
...
- "desc": "The vampire makes two attacks, using Grave Strike or Sickening Ray in any\
    \ combination."
  "name": "Multiattack"
- "desc": "Melee Attack: dice:1d20+10|noform|text(+10), reach 5 ft. Hit: dice:1d8+5|noform|avg|text(9)\
    \ (1d8 + 5) Slashing damage plus dice:3d8|noform|avg|text(13) (3d8) Necrotic\
    \ damage."
  "name": "Grave Strike"
- "desc": "Ranged Attack: dice:1d20+10|noform|text(+10), range 120 ft. Hit:\
    \ dice:2d10+5|noform|avg|text(16) (2d10 + 5) Necrotic damage, and the target\
    \ has the [Poisoned](rules/conditions.md#Poisoned) condition until the start of\
    \ the vampire's next turn."
  "name": "Sickening Ray"
"bonus_actions":
- "desc": "Constitution Saving Throw: DC 18, one creature the vampire can see within\
    \ 30 feet that isn't a Construct or an Undead. Failure: dice:4d6|noform|avg|text(14)\
    \ (4d6) Necrotic damage. The target's [Hit Points](rules/variant-rules/hit-points-xphb.md)\
...
"source":
- "XMM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/XMM/Vampire%20Umbral%20Lord.webp"
```
^statblock
