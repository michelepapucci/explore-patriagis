...
- "desc": "Melee Attack: dice:1d20+4|noform|text(+4), reach 5 ft. Hit: dice:2d6+2|noform|avg|text(9)\
    \ (2d6 + 2) Cold damage, and the target's [Speed](rules/variant-rules/speed-xphb.md)\
...
- "desc": "Melee Attack: dice:1d20+4|noform|text(+4), reach 5 ft. Hit: dice:1d4+2|noform|avg|text(4)\
  ...
  "name": "Claw"
"bonus_actions":
- "desc": "While underwater, the ghoul moves up to half its [Swim Speed](rules/variant-rules/swim-speed-xphb.md)\
