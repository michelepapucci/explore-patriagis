...
- "desc": "The poltergeist can move through other creatures and objects as if they\
    \ were [Difficult Terrain](rules/variant-rules/difficult-terrain-xphb.md). It\
    \ takes dice:1d10|noform|avg|text(5) (1d10) Force damage if it ends its turn\
    \ inside an object."
  "name": "Incorporeal Movement"
"actions":
- "desc": "The poltergeist makes one [Object](rules/variant-rules/object-xphb.md)\
    \ Slam attack and uses Telekinetic Thrust."
  "name": "Multiattack"
- "desc": "Melee or Ranged Attack: dice:1d20+4|noform|text(+4), reach 5 ft. or\
    \ range 30 ft. Hit: dice:2d4+2|noform|avg|text(7) (2d4 + 2) Bludgeoning\
    \ damage."
  "name": "Object Slam"
- "desc": "Strength Saving Throw: DC 12, one creature the poltergeist can see within\
    \ 30 feet. Failure: dice:2d6+2|noform|avg|text(9) (2d6 + 2) Force damage,\
    \ and the target is pushed up to 30 feet straight away from the poltergeist."
  "name": "Telekinetic Thrust"
"bonus_actions":
- "desc": "The poltergeist gives itself the [Invisible](rules/conditions.md#Invisible)\
