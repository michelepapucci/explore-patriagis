...
- "desc": "Melee Attack: dice:1d20+4|noform|text(+4), reach 5 ft. Hit: dice:1d6+2|noform|avg|text(5)\
    \ (1d6 + 2) Bludgeoning damage plus dice:1d4|noform|avg|text(2) (1d4) Radiant\
    \ damage."
  "name": "Mace"
- "desc": "Ranged Attack: dice:1d20+4|noform|text(+4), range 60 ft. Hit: dice:2d6|noform|avg|text(7)\
    \ (2d6) Radiant damage."
  "name": "Radiant Flame"
"source":
- "XMM"
