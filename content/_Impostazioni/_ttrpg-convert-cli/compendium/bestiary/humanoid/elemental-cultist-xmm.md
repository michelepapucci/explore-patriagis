...
- "desc": "The cultist makes three attacks, using Elemental Flail or Elemental Claw\
    \ in any combination."
  "name": "Multiattack"
- "desc": "Melee Attack: dice:1d20+7|noform|text(+7), reach 5 ft. Hit: dice:6d6+4|noform|avg|text(25)\
    \ (6d6 + 4) damage of a type chosen by the cultist: Acid, Cold, Fire, Lightning,\
    \ or Thunder."
  "name": "Elemental Flail"
- "desc": "Ranged Attack: dice:1d20+7|noform|text(+7), range 120 ft. Hit: dice:4d10|noform|avg|text(22)\
    \ (4d10) damage of a type chosen by the cultist: Acid, Cold, Fire, Lightning,\
    \ or Thunder. If the target is a Medium or smaller creature, the cultist moves\
    \ the target up to 10 feet straight toward or away from itself."
  "name": "Elemental Claw"
"reactions":
- "desc": "Trigger: The cultist takes Acid, Cold, Fire, Lightning, or Thunder damage.\
    \ Response: The cultist gives itself [Resistance](rules/variant-rules/resistance-xphb.md)\
    \ to that instance of damage and gains 10 [Temporary Hit Points](rules/variant-rules/temporary-hit-points-xphb.md)."
