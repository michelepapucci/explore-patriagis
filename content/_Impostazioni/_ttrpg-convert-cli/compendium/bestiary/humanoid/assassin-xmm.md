...
- "desc": "Melee Attack: dice:1d20+7|noform|text(+7), reach 5 ft. Hit: dice:1d6+4|noform|avg|text(7)\
    \ (1d6 + 4) Piercing damage plus dice:5d6|noform|avg|text(17) (5d6) Poison\
    \ damage, and the target has the [Poisoned](rules/conditions.md#Poisoned) condition\
    \ until the start of the assassin's next turn."
  "name": "Shortsword"
- "desc": "Ranged Attack: dice:1d20+7|noform|text(+7), range 80/320 ft. Hit:\
    \ dice:1d8+4|noform|avg|text(8) (1d8 + 4) Piercing damage plus dice:6d6|noform|avg|text(21)\
    \ (6d6) Poison damage."
  "name": "Light Crossbow"
"bonus_actions":
