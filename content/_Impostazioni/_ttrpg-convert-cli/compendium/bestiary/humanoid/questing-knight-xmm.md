...
- "desc": "The knight casts one of the following spells, using Charisma as the spellcasting\
  ...
  "name": "Spellcasting"
- "desc": "Creatures of the knight's choice in a 30-foot [Emanation [Area of Effect]](rules/variant-rules/emanation-area-of-effect-xphb.md)\
    \ originating from it have [Immunity](rules/variant-rules/immunity-xphb.md) to\
...
- "desc": "Melee Attack: dice:1d20+9|noform|text(+9), reach 5 ft. Hit: dice:2d6+5|noform|avg|text(12)\
    \ (2d6 + 5) Slashing damage plus dice:5d8|noform|avg|text(22) (5d8) Radiant\
    \ damage."
  "name": "Greatsword"
- "desc": "Ranged Attack: dice:1d20+7|noform|text(+7), range 150/600 ft. Hit:\
    \ dice:2d8+3|noform|avg|text(12) (2d8 + 3) Piercing damage plus dice:5d8|noform|avg|text(22)\
    \ (5d8) Radiant damage."
  "name": "Longbow"
"source":
- "XMM"
