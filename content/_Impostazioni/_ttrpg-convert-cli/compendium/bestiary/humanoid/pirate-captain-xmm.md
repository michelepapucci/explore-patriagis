...
- "desc": "Melee Attack: dice:1d20+7|noform|text(+7), reach 5 ft. Hit: dice:2d8+4|noform|avg|text(13)\
    \ (2d8 + 4) Piercing damage, and the pirate has [Advantage](rules/variant-rules/advantage-xphb.md)\
    \ on the next attack roll it makes before the end of this turn."
  "name": "Rapier"
- "desc": "Ranged Attack: dice:1d20+7|noform|text(+7), range 30/90 ft. Hit:\
    \ dice:2d10+4|noform|avg|text(15) (2d10 + 4) Piercing damage."
  "name": "Pistol"
"bonus_actions":
...
"source":
- "XMM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/XMM/Pirate%20Captain.webp"
```
^statblock
