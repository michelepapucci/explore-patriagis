...
- "desc": "Melee or Ranged Attack: dice:1d20+6|noform|text(+6), reach 5 ft. or\
    \ range 20/60 ft. Hit: dice:2d4+3|noform|avg|text(8) (2d4 + 3) Piercing\
    \ damage plus dice:3d6|noform|avg|text(10) (3d6) Poison damage."
  "name": "Dagger"
- "desc": "Constitution Saving Throw: DC 14, each creature in a 10-foot-radius [Sphere\
    ...
    \ on a point the bandit can see within 120 feet. Failure: dice:3d6+3|noform|avg|text(13)\
    \ (3d6 + 3) Radiant damage, and the target has the [Blinded](rules/conditions.md#Blinded)\
