...
- "desc": "The pudding can move through a space as narrow as 1 inch without expending\
  ...
  "name": "Amorphous"
- "desc": "A creature that hits the pudding with a melee attack roll takes dice:1d8|noform|avg|text(4)\
    ...
    \ -1 penalty to attack rolls immediately after dealing damage to the pudding and\
...
- "desc": "The pudding can climb difficult surfaces, including along ceilings, without\
  ...
  "name": "Spider Climb"
"actions":
- "desc": "Melee Attack: dice:1d20+5|noform|text(+5), reach 10 ft. Hit: dice:4d6+3|noform|avg|text(17)\
    \ (4d6 + 3) Acid damage. Nonmagical armor worn by the target takes a -1 penalty\
...
"reactions":
- "desc": "Trigger: While the pudding is Large or Medium and has 10+ [Hit Points](rules/variant-rules/hit-points-xphb.md),\
    \ it becomes [Bloodied](rules/variant-rules/bloodied-xphb.md) or is subjected\
    \ to Lightning or Slashing damage. Response: The pudding splits into two new Black\
    \ Puddings. Each new pudding is one size smaller than the original pudding and\
    \ acts on its [Initiative](rules/variant-rules/initiative-xphb.md). The original\
    \ pudding's [Hit Points](rules/variant-rules/hit-points-xphb.md) are divided evenly\
