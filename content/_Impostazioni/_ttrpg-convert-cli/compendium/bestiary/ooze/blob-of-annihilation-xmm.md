...
"cr": "23"
"traits":
- "desc": "If the blob is reduced to 0 [Hit Points](rules/variant-rules/hit-points-xphb.md),\
    ...
    \ that was within 600 feet of it. In dice:1d20|noform|avg () years, the blob\
    \ reconstitutes on a random world in the Material Plane."
  "name": "Astral Implosion"
- "desc": "If the blob fails a saving throw, it can choose to succeed instead."
  "name": "Legendary Resistance (4/Day)"
- "desc": "The blob has [Advantage](rules/variant-rules/advantage-xphb.md) on saving\
...
- "desc": "The blob makes two Pseudopod attacks and uses Engulf. It can replace one\
  ...
  "name": "Multiattack"
- "desc": "Melee Attack: dice:1d20+15|noform|text(+15), reach 30 ft. Hit: dice:3d10+8|noform|avg|text(24)\
    \ (3d10 + 8) Force damage."
  "name": "Pseudopod"
- "desc": "The blob moves up to its [Speed](rules/variant-rules/speed-xphb.md) and\
    \ can move through the spaces of Huge or smaller creatures and objects. Strength\
    ...
    \ a target has [Cover](rules/variant-rules/cover-xphb.md) against attacks and\
    \ other effects outside the blob, and when the blob moves, the engulfed target\
    \ moves with it. A nonmagical object is destroyed after spending 1 minute engulfed.\n\
    \nWhile engulfed, a creature takes dice:6d6|noform|avg|text(21) (6d6) Force\
    \ damage at the start of each of its turns, is suffocating, has the [Restrained](rules/conditions.md#Restrained)\
    \ condition, and repeats the save at the end of each of its turns. An engulfed\
    \ creature that is reduced to 0 [Hit Points](rules/variant-rules/hit-points-xphb.md)\
...
- "desc": "The blob lobs a slimy glob at one Large or smaller creature it can see\
    ...
    \ Failure: dice:3d6+8|noform|avg|text(18) (3d6 + 8) Acid damage. The glob\
    \ rolls the target 60 feet straight toward the blob, and the target has the [Restrained](rules/conditions.md#Restrained)\
    \ condition until the end of its next turn, when the glob harmlessly dissolves.\
    \ Success: Half damage only."
  "name": "Restraining Glob"
"legendary_actions":
- "desc": "The blob deals dice:4d6|noform|avg|text(14) (4d6) Necrotic damage to\
    \ each creature engulfed by it. The blob can't take this action again until the\
