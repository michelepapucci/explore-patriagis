...
"cr": "5"
"actions":
- "desc": "Melee Attack: dice:1d20+8|noform|text(+8), reach 5 ft. Hit: dice:2d12+5|noform|avg|text(18)\
    \ (2d12 + 5) Piercing damage. If the target is a Large or smaller creature and\
    \ the gorgon moved 20+ feet straight toward it immediately before the hit, the\
...
- "desc": "Constitution Saving Throw: DC 15, each creature in a 30-foot [Cone [Area\
    ...
    \ 1} The target has the [Restrained](rules/conditions.md#Restrained) condition\
    \ and repeats the save at the end of its next turn if it is still [Restrained](rules/conditions.md#Restrained),\
...
- "desc": "Dexterity Saving Throw: DC 16, one creature within 5 feet that has the\
    \ [Prone](rules/conditions.md#Prone) condition. Failure: dice:2d10+5|noform|avg|text(16)\
