...
- "desc": "Melee Attack: dice:1d20+4|noform|text(+4), reach 5 ft. Hit: dice:1d4+2|noform|avg|text(4)\
    \ (1d4 + 2) Force damage."
  "name": "Slam"
- "desc": "Ranged Attack: dice:1d20+4|noform|text(+4), range 320 ft. Hit: dice:1d4+2|noform|avg|text(4)\
    \ (1d4 + 2) Force damage."
  "name": "Gears Launcher"
"source":
- "XMM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/XMM/Modron%20Quadrone.webp"
```
^statblock
