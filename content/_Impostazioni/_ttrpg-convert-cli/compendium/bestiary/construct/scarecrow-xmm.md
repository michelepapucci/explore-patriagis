...
- "desc": "Melee Attack: dice:1d20+3|noform|text(+3), reach 5 ft. Hit: dice:2d4+1|noform|avg|text(6)\
    \ (2d4 + 1) Slashing damage, and the target has the [Frightened](rules/conditions.md#Frightened)\
...
- "desc": "Wisdom Saving Throw: DC 11, one creature the scarecrow can see within\
    ...
    \ condition until the end of the scarecrow's next turn. While [Frightened](rules/conditions.md#Frightened),\
