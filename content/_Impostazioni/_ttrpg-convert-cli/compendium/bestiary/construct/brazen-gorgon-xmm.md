...
- "desc": "At the end of each of the gorgon's turns, each creature in a 5-foot [Emanation\
    ...
    \ from the gorgon takes dice:3d8|noform|avg|text(13) (3d8) Fire damage."
  "name": "Flame Aura"
- "desc": "The gorgon sheds [Bright Light](rules/variant-rules/bright-light-xphb.md)\
...
- "desc": "The gorgon makes two Gore attacks."
  "name": "Multiattack"
- "desc": "Melee Attack: dice:1d20+8|noform|text(+8), reach 5 ft. Hit: dice:2d6+4|noform|avg|text(11)\
    \ (2d6 + 4) Piercing damage plus dice:3d6|noform|avg|text(10) (3d6) Fire\
    \ damage."
  "name": "Gore"
- "desc": "The gorgon moves up to its [Speed](rules/variant-rules/speed-xphb.md) without\
    \ provoking Opportunity Attacks and can move through the spaces of Medium or smaller\
    \ creatures. Each time the gorgon enters a creature's space for the first time\
    \ during this move, that target is subjected to the following effect. Dexterity\
    \ Saving Throw: DC 16. Failure: dice:2d8+4|noform|avg|text(13) (2d8 + 4)\
    \ Piercing damage plus dice:3d8|noform|avg|text(13) (3d8) Fire damage, and\
    \ the target is pulled into the gorgon's space and has the [Grappled](rules/conditions.md#Grappled)\
    \ condition (escape DC 14); if the gorgon already has a creature [Grappled](rules/conditions.md#Grappled),\
    \ the target has the [Prone](rules/conditions.md#Prone) condition instead. Until\
    \ the grapple ends, the target has the [Restrained](rules/conditions.md#Restrained)\
    \ condition. When the gorgon moves, the [Grappled](rules/conditions.md#Grappled)\
