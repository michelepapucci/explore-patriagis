...
- "desc": "Melee Attack: dice:1d20+5|noform|text(+5), reach 5 ft. Hit: dice:2d6+3|noform|avg|text(10)\
    \ (2d6 + 3) Bludgeoning damage. If the target is a Medium or smaller creature,\
    \ the rug can give it the [Grappled](rules/conditions.md#Grappled) condition (escape\
    ...
    \ conditions, is suffocating, and takes dice:2d6+3|noform|avg|text(10) (2d6\
    \ + 3) Bludgeoning damage at the start of each of its turns. The rug can smother\
    \ only one creature at a time.\n\nWhile grappling the target, the rug can't take\
    \ this action, the rug halves the damage it takes (round down), and the target\
    \ takes the same amount of damage."
  "name": "Smother"
"source":
- "XMM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/XMM/Animated%20Rug%20of%20Smothering.webp"
```
^statblock
