...
- "desc": "Whenever the golem is subjected to Fire damage, it regains a number of\
    \ [Hit Points](rules/variant-rules/hit-points-xphb.md) equal to the Fire damage\
    \ dealt."
...
- "desc": "The golem makes two attacks, using Bladed Arm or Fiery Bolt in any combination."
  "name": "Multiattack"
- "desc": "Melee Attack: dice:1d20+12|noform|text(+12), reach 10 ft. Hit: dice:3d8+7|noform|avg|text(20)\
    \ (3d8 + 7) Slashing damage plus dice:3d6|noform|avg|text(10) (3d6) Fire\
    \ damage."
  "name": "Bladed Arm"
- "desc": "Ranged Attack: dice:1d20+10|noform|text(+10), range 120 ft. Hit:\
    \ dice:8d8|noform|avg|text(36) (8d8) Fire damage."
  "name": "Fiery Bolt"
- "desc": "Constitution Saving Throw: DC 18, each creature in a 60-foot [Cone [Area\
    \ of Effect]](rules/variant-rules/cone-area-of-effect-xphb.md). Failure: dice:10d10|noform|avg|text(55)\
    \ (10d10) Poison damage. Success: Half damage."
