...
- "desc": "The colossus has [Advantage](rules/variant-rules/advantage-xphb.md) on\
...
- "desc": "The colossus makes three attacks, using Slam or Radiant Ray in any combination."
  "name": "Multiattack"
- "desc": "Melee Attack: dice:1d20+18|noform|text(+18), reach 20 ft. Hit: dice:4d10+10|noform|avg|text(32)\
    \ (4d10 + 10) Bludgeoning damage, and the colossus pushes the target up to 20\
    \ feet straight away from itself."
  "name": "Slam"
- "desc": "Ranged Attack: dice:1d20+18|noform|text(+18), range 300 ft. Hit:\
    \ dice:4d10|noform|avg|text(22) (4d10) Radiant damage. If the target is a\
    \ Large or smaller creature, it has the [Prone](rules/conditions.md#Prone) condition."
  "name": "Radiant Ray"
- "desc": "Dexterity Saving Throw: DC 26, each creature in a 300-foot-long, 10-foot-wide\
    ...
    \ dice:10d12|noform|avg|text(65) (10d12) Radiant damage. Success: Half damage.\
    \ Failure or Success: A creature reduced to 0 [Hit Points](rules/variant-rules/hit-points-xphb.md)\
...
- "desc": "The colossus makes one Radiant Ray attack."
  "name": "Smite"
- "desc": "The colossus moves up to half its [Speed](rules/variant-rules/speed-xphb.md)\
