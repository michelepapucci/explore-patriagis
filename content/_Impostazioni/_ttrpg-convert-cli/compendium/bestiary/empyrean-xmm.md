...
- "desc": "The empyrean casts one of the following spells, requiring no Material components\
    ...
    \ [Calm Emotions](compendium/spells/calm-emotions-xphb.md), [Greater Restoration](compendium/spells/greater-restoration-xphb.md),\
    \ [Pass without Trace](compendium/spells/pass-without-trace-xphb.md), [Water Breathing](compendium/spells/water-breathing-xphb.md)\n\
    \n1/day each: [Commune](compendium/spells/commune-xphb.md), [Dispel Evil and\
    \ Good](compendium/spells/dispel-evil-and-good-xphb.md), [Plane Shift](compendium/spells/plane-shift-xphb.md)"
  "name": "Spellcasting"
- "desc": "If the empyrean fails a saving throw, it can choose to succeed instead."
  "name": "Legendary Resistance (4/Day)"
- "desc": "The empyrean has [Advantage](rules/variant-rules/advantage-xphb.md) on\
...
- "desc": "The empyrean makes two attacks, using Sacred Weapon or Divine Ray in any\
    \ combination."
  "name": "Multiattack"
- "desc": "Melee Attack: dice:1d20+17|noform|text(+17), reach 10 ft. Hit: dice:6d6+10|noform|avg|text(31)\
    \ (6d6 + 10) Force damage, and the target has the [Stunned](rules/conditions.md#Stunned)\
    \ condition until the start of the empyrean's next turn. The target can choose\
    \ not to be [Stunned](rules/conditions.md#Stunned), in which case it takes an\
    \ extra 21 Force damage that bypasses [Resistance](rules/variant-rules/resistance-xphb.md)\
    \ or [Immunity](rules/variant-rules/immunity-xphb.md)."
  "name": "Sacred Weapon"
- "desc": "Ranged Attack: dice:1d20+15|noform|text(+15), range 600 ft. Hit:\
    \ dice:6d8+8|noform|avg|text(35) (6d8 + 8) Necrotic or Radiant damage (empyrean's\
    \ choice)."
  "name": "Divine Ray"
"legendary_actions":
- "desc": "The empyrean gains 10 [Temporary Hit Points](rules/variant-rules/temporary-hit-points-xphb.md),\
    \ and the empyrean and each ally within 30 feet of it gain [Advantage](rules/variant-rules/advantage-xphb.md)\
    \ on [D20 Test](rules/variant-rules/d20-test-xphb.md) until the end of the empyrean's\
...
- "desc": "Constitution Saving Throw: DC 23, each creature in a 30-foot [Emanation\
    ...
    \ from the empyrean. Failure: dice:6d8|noform|avg|text(27) (6d8) Force damage,\
    \ and the target has the [Prone](rules/conditions.md#Prone) condition. Success:\
