...
- "desc": "Melee Attack: dice:1d20+3|noform|text(+3), reach 5 ft. Hit: dice:2d4+1|noform|avg|text(6)\
  ...
  "name": "Claw"
- "desc": "Ranged Attack: dice:1d20+3|noform|text(+3), range 30/60 ft. Hit:\
    \ dice:2d4+1|noform|avg|text(6) (2d4 + 1) Piercing damage."
  "name": "Needles"
"source":
- "XMM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/XMM/Needle%20Blight.webp"
```
^statblock
