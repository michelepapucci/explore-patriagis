...
- "desc": "Melee Attack: dice:1d20+10|noform|text(+10), reach 5 ft. Hit: dice:3d6+6|noform|avg|text(16)\
  ...
  "name": "Slam"
- "desc": "Ranged Attack: dice:1d20+10|noform|text(+10), range 180 ft. Hit:\
...
- "desc": "The treant magically animates up to two trees it can see within 60 feet\
    ...
    \ takes its turn immediately after the treant on the same [Initiative](rules/variant-rules/initiative-xphb.md)\
