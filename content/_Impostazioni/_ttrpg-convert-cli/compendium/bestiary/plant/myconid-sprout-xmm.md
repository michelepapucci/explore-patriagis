...
- "desc": "While in sunlight, the myconid has [Disadvantage](rules/variant-rules/disadvantage-xphb.md)\
  ...
  "name": "Sun Sickness"
"actions":
- "desc": "Melee Attack: dice:1d20+1|noform|text(+1), reach 5 ft. Hit: dice:1d4-1|noform|avg|text(1)\
    \ (1d4 - 1) Bludgeoning damage plus dice:1d4|noform|avg|text(2) (1d4) Poison\
    \ damage."
  "name": "Slam"
...
"source":
- "XMM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/XMM/Myconid%20Sprout.webp"
```
^statblock
