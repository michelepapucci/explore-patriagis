...
- "desc": "The blight makes two Branch attacks and uses Grasping Root."
  "name": "Multiattack"
- "desc": "Melee Attack: dice:1d20+9|noform|text(+9), reach 15 ft. Hit: dice:3d6+6|noform|avg|text(16)\
...
- "desc": "Strength Saving Throw: DC 17, one Large or smaller creature the blight\
    ...
    \ toward the blight and has the [Grappled](rules/conditions.md#Grappled) condition\
    \ (escape DC 16) from one of six roots. Until the grapple ends, the target takes\
    \ dice:2d6+6|noform|avg|text(13) (2d6 + 6) Bludgeoning damage at the start\
    \ of each of its turns."
  "name": "Grasping Root"
"bonus_actions":
- "desc": "Dexterity Saving Throw: DC 17, one creature [Grappled](rules/conditions.md#Grappled)\
    \ by the blight. Failure: dice:3d8+6|noform|avg|text(19) (3d8 + 6) Piercing\
    \ damage. Success: Half damage."
  "name": "Gnash"
"source":
- "XMM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/XMM/Tree%20Blight.webp"
```
^statblock
