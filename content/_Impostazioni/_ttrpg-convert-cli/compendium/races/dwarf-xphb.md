...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/races/XPHB/Dwarf.webp#right)
...
Your [Hit Points](rules/variant-rules/hit-points-xphb.md) maximum increases by 1, and it increases by 1 again whenever you gain a level.
...
You can use this [Bonus Action](rules/variant-rules/bonus-action-xphb.md) a number of times equal to your [Proficiency](rules/variant-rules/proficiency-xphb.md), and you regain all expended uses when you finish a [Long Rest](rules/variant-rules/long-rest-xphb.md).
