...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/races/XPHB/Gnome.webp#right)
...
- **Forest Gnome.** You know the [Minor Illusion](compendium/spells/minor-illusion-xphb.md) cantrip. You also always have the [Speak with Animals](compendium/spells/speak-with-animals-xphb.md) spell prepared. You can cast it without a spell slot a number of times equal to your [Proficiency](rules/variant-rules/proficiency-xphb.md), and you regain all expended uses when you finish a [Long Rest](rules/variant-rules/long-rest-xphb.md). You can also use any spell slots you have to cast the spell.  
