...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/races/XPHB/Halfling.webp#right)
...
When you roll a 1 on the `dice:d20|noform|avg` (`d20`) of a [D20 Test](rules/variant-rules/d20-test-xphb.md), you can reroll the die, and you must use the new roll.
