...
When any creature whose name is on the page is reduced to 0 [Hit Points](rules/variant-rules/hit-points-xphb.md) but not killed outright, the creature magically drops to 1 [Hit Points](rules/variant-rules/hit-points-xphb.md) instead. Once this magic is triggered, no creature can benefit from it until you finish a [Long Rest](rules/variant-rules/long-rest-xphb.md).
