...
When the creature is hit by an attack roll, that creature can use its [Reaction](rules/variant-rules/reaction-xphb.md) to roll the Bardic Inspiration die and add the number rolled to its AC against that attack, potentially causing the attack to miss.
...
In addition, you can use a Simple or Martial weapon as a [Spellcasting Focus](rules/variant-rules/spellcasting-focus-xphb.md) to cast spells from your Bard spell list.
...
After you cast a spell that has a casting time of an action, you can make one attack with a weapon as a [Bonus Action](rules/variant-rules/bonus-action-xphb.md).