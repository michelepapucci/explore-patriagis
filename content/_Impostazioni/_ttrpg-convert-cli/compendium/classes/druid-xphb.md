...
- **Armor Training**: [Light armor](rules/item-types.md#Light%20Armor) and [Shields](compendium/items/shield-xphb.md)
...
- **Armor Training**: [Light armor](rules/item-types.md#Light%20Armor), [Shields](compendium/items/shield-xphb.md)
...
You can use a [Druidic Focus](compendium/items/druidic-focus-xphb.md) as a [Spellcasting Focus](rules/variant-rules/spellcasting-focus-xphb.md) for your Druid spells.
...
- **Game Statistics.** Your game statistics are replaced by the Beast's stat block, but you retain your creature type; [Hit Points](rules/variant-rules/hit-points-xphb.md); [Hit Point Dice](rules/variant-rules/hit-point-dice-xphb.md); Intelligence, Wisdom, and Charisma scores; class features; languages; and feats. You also retain your skill and saving throw proficiencies and use your [Proficiency](rules/variant-rules/proficiency-xphb.md) for them, in addition to gaining the proficiencies of the creature. If a skill or saving throw modifier in the Beast's stat block is higher than yours, use the one in the stat block.  
