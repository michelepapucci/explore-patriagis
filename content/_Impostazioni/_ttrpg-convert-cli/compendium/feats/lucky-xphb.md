...
When you roll a `dice:d20|noform|avg` (`d20`) for a [D20 Test](rules/variant-rules/d20-test-xphb.md), you can spend 1 Luck Point to give yourself Advantage on the roll.
