...
*Use this column for [Cylinder [Area of Effect]](rules/variant-rules/cylinder-area-of-effect-xphb.md), [Emanation [Area of Effect]](rules/variant-rules/emanation-area-of-effect-xphb.md) (using the size of the Emanation rather than its radius), and [Sphere [Area of Effect]](rules/variant-rules/sphere-area-of-effect-xphb.md).