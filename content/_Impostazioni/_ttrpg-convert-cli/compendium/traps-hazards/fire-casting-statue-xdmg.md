...
When a creature moves onto this trap's pressure plate for the first time on a turn or starts its turn there, a nearby statue exhales a 15-foot [Cone [Area of Effect]](rules/variant-rules/cone-area-of-effect-xphb.md) of magical flame. The statue can look like anything, such as a dragon or a wizard. Each creature in the Cone must succeed on a DC 15 Dexterity saving throw, taking `dice:2d10|noform|avg|text(11)` (`2d10`) Fire damage on a failed save or half as much damage on a successful one.
