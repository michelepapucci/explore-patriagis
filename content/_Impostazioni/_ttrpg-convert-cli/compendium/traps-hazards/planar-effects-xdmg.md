...
The plane of "Acheron" rewards a creature for harming other creatures by imbuing it with the strength to keep fighting. While in Acheron or a region under its influence, a creature gains [Temporary Hit Points](rules/variant-rules/temporary-hit-points-xphb.md) equal to half its Hit Point maximum whenever it reduces another creature to 0 Hit Points.

## Arcadian Vitality

On the plane of "Arcadia" and in regions where its influence is felt, creatures benefit from supernatural vitality, which grants them [Immunity](rules/variant-rules/immunity-xphb.md) the [Frightened](rules/conditions.md#Frightened) and [Poisoned](rules/conditions.md#Poisoned) conditions.
...
On the plane of "Gehenna" and in regions where its influence is felt, creatures are driven to loathe helping one another. Whenever a creature subject to Gehennan cruelty casts a spell, including a spell that restores Hit Points or removes a condition other than [Invisible](rules/conditions.md#Invisible), the caster must succeed on a DC 10 Charisma saving throw, or the spell fails and is wasted.

## Winds of Pandemonium

The winds of "Pandemonium" are common in Pandemonium and regions where its influence is felt, including parts of the Underdark. A creature makes a DC 10 Wisdom saving throw after each hour spent among the howling winds. On a failed save, the creature gains 1 [Exhaustion](rules/conditions.md#Exhaustion) level. The winds can't increase a creature's [Exhaustion](rules/conditions.md#Exhaustion) level above 3. Finishing a Long Rest doesn't reduce a creature's Exhaustion level unless the creature can somehow escape the winds.
