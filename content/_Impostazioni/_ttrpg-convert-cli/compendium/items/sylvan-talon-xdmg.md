...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/items/XDMG/Sylvan%20Talon.webp#right)
...
As a [Magic](rules/actions.md#Magic) action, you can use the weapon to cast [Message](compendium/spells/message-xphb.md). Once this property is used, it can't be used again until the next dawn.
