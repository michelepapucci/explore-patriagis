...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/items/XDMG/Holy%20Avenger.webp#right)
...
While you hold the drawn weapon, it creates a 10-foot [Emanation [Area of Effect]](rules/variant-rules/emanation-area-of-effect-xphb.md) originating from you. You and all creatures [Friendly [Attitude]](rules/variant-rules/friendly-attitude-xphb.md) to you in the [Emanation [Area of Effect]](rules/variant-rules/emanation-area-of-effect-xphb.md) have [Advantage](rules/variant-rules/advantage-xphb.md) on saving throws against spells and other magical effects. If you have 17 or more levels in the Paladin class, the size of the [Emanation [Area of Effect]](rules/variant-rules/emanation-area-of-effect-xphb.md) increases to 30 feet.
...
- **Damage**: 2d4 S
- **Properties**: [Two-Handed](rules/item-properties.md#Two-Handed), special
- **Weight**: 6.0 lbs.
...
- **Damage**: 1d6 P
- **Range**: 40/160
- **Properties**: [Ammunition](rules/item-properties.md#Ammunition), [Finesse](rules/item-properties.md#Finesse), [Two-Handed](rules/item-properties.md#Two-Handed), special
- **Weight**: 2.0 lbs.
