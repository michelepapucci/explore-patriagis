...
The cube has 3 charges and regains `dice:1d3|noform|avg` (`1d3`) expended charges daily at dawn. As a [Magic](rules/actions.md#Magic) action, you can expend 1 of the cube's charges to cast one of the following spells using the cube.
