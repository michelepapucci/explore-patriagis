...
Make a ranged attack roll with an attack bonus equal to your Dexterity modifier plus your [Proficiency](rules/variant-rules/proficiency-xphb.md). On a hit, the target has the [Restrained](rules/conditions.md#Restrained) condition until you take a [Bonus Action](rules/variant-rules/bonus-action-xphb.md) to issue a command that releases it. Doing so or missing with the attack causes the bands to contract and become a sphere once more.
