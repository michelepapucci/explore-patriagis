...
# Rope of Entanglement
*Wondrous item, rare*  
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/items/XDMG/Rope%20of%20Entanglement.webp#right)
...
The rope has AC 20, HP 20, and [Immunity](rules/variant-rules/immunity-xphb.md) to Poison and Psychic damage. It regains 1 [Hit Points](rules/variant-rules/hit-points-xphb.md) every 5 minutes as long as it has at least 1 [Hit Points](rules/variant-rules/hit-points-xphb.md). If the rope drops to 0 [Hit Points](rules/variant-rules/hit-points-xphb.md), it is destroyed.
