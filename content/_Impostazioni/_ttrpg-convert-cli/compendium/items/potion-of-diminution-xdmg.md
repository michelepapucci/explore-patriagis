...
When you drink this potion, you gain the "reduce" effect of the [Enlarge/Reduce](compendium/spells/enlarge-reduce-xphb.md) spell for `dice:1d4|noform|avg` (`1d4`) hours (no [Concentration](rules/conditions.md#Concentration) required).
