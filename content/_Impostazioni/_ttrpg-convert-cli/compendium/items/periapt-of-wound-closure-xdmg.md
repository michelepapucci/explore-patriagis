...
Whenever you roll a [Hit Points](rules/variant-rules/hit-points-xphb.md) Die to regain [Hit Points](rules/variant-rules/hit-points-xphb.md), double the number of [Hit Points](rules/variant-rules/hit-points-xphb.md) it restores.
