...
The next time you enter combat against one or more [Hostile [Attitude]](rules/variant-rules/hostile-attitude-xphb.md) creatures, you can select one of them as your foe when you roll [Initiative](rules/variant-rules/initiative-xphb.md). If you reduce your foe to 0 [Hit Points](rules/variant-rules/hit-points-xphb.md) during that combat, you have [Advantage](rules/variant-rules/advantage-xphb.md) on Death Saving Throws for 1 year. If someone else reduces your chosen foe to 0 [Hit Points](rules/variant-rules/hit-points-xphb.md) or you don't choose a foe, this card has no effect.
...
You have [Disadvantage](rules/variant-rules/disadvantage-xphb.md) on [D20 Test](rules/variant-rules/d20-test-xphb.md) for the next 72 hours. Draw another card; this draw doesn't count as one of your declared draws.
...
You have [Advantage](rules/variant-rules/advantage-xphb.md) on [D20 Test](rules/variant-rules/d20-test-xphb.md) for the next 72 hours, or you can draw two additional cards beyond your declared draws.
...
You gain the ability to cast [Wish](compendium/spells/wish-xphb.md) `dice:1d3|noform|avg` (`1d3`) times.
...
You gain proficiency and [Expertise](rules/variant-rules/expertise-xphb.md) in your choice of [History](rules/skills.md#History), [Insight](rules/skills.md#Insight), [Intimidation](rules/skills.md#Intimidation), or [Persuasion](rules/skills.md#Persuasion). In addition, you gain rightful ownership of a small keep somewhere in the world. However, the keep is currently home to one or more monsters, which must be cleared out before you can claim the keep as yours.
