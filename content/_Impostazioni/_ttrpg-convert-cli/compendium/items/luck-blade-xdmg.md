...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/items/XDMG/Luck%20Blade.webp#right)
...
The weapon has `dice:1d3|noform|avg` (`1d3`) charges. While holding it, you can expend 1 charge and cast [Wish](compendium/spells/wish-xphb.md) from it. Once used, this property can't be used again until the next dawn. The weapon loses this property if it has no charges.
