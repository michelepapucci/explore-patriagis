...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/items/XDMG/Sword%20of%20Life%20Stealing.webp#right)


When you attack a creature with this magic weapon and roll a 20 on the `dice:d20|noform|avg` (`d20`) for the attack roll, that target takes an extra 15 Necrotic damage if it isn't a Construct or an Undead, and you gain [Temporary Hit Points](rules/variant-rules/temporary-hit-points-xphb.md) equal to the amount of Necrotic damage taken.
