...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/items/XDMG/Frost%20Brand.webp#right)


When you hit with an attack roll using this magic weapon, the target takes an extra `dice:1d6|noform|avg` (`1d6`) Cold damage. In addition, while you hold the weapon, you have [Resistance](rules/variant-rules/resistance-xphb.md) to Fire damage.
