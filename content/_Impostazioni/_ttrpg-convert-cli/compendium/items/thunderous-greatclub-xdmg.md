...
As a [Magic](rules/actions.md#Magic) action, you can strike the weapon against a hard surface to create a loud clap of thunder audible out to 300 feet. You also create a 30-foot [Cone [Area of Effect]](rules/variant-rules/cone-area-of-effect-xphb.md) of thunderous energy. Each creature in the [Cone [Area of Effect]](rules/variant-rules/cone-area-of-effect-xphb.md) must succeed on a DC 15 Strength saving throw or have the [Prone](rules/conditions.md#Prone) condition. Nonmagical objects in the [Cone [Area of Effect]](rules/variant-rules/cone-area-of-effect-xphb.md) that aren't being worn or carried take `dice:3d8|noform|avg` (`3d8`) Thunder damage.
