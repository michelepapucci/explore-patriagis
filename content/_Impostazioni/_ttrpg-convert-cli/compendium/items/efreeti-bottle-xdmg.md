...
When you take a [Magic](rules/actions.md#Magic) action to remove the stopper of this painted brass bottle, a cloud of thick smoke flows out of it. At the end of your turn, the smoke disappears with a flash of harmless fire, and an [Efreeti](compendium/bestiary/elemental/efreeti-xmm.md) appears in an unoccupied space within 30 feet of you.
...
| 2-9 | The [efreeti](compendium/bestiary/elemental/efreeti-xmm.md) understands your languages and obeys your commands for 1 hour, after which it returns to the bottle, and a new stopper contains it. The stopper can't be removed for 24 hours. The next two times the bottle is opened, the same effect occurs. If the bottle is opened a fourth time, the efreeti escapes and disappears, and the bottle loses its magic. |
