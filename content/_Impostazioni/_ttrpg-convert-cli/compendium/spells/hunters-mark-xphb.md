...
You magically mark one creature you can see within range as your quarry. Until the spell ends, you deal an extra `dice:1d6|noform|avg` (`1d6`) Force damage to the target whenever you hit it with an attack roll. You also have [Advantage](rules/variant-rules/advantage-xphb.md) on any Wisdom ([Perception](rules/skills.md#Perception) or [Survival](rules/skills.md#Survival)) check you make to find it.
