...
The target takes an extra `dice:4d6|noform|avg` (`4d6`) Psychic damage from the attack, and the target must succeed on a Wisdom saving throw or have the [Stunned](rules/conditions.md#Stunned) condition until the end of your next turn.
