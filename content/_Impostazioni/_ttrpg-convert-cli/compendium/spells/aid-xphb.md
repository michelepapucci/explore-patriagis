...
Choose up to three creatures within range. Each target's [Hit Points](rules/variant-rules/hit-points-xphb.md) maximum and current [Hit Points](rules/variant-rules/hit-points-xphb.md) increase by 5 for the duration.
