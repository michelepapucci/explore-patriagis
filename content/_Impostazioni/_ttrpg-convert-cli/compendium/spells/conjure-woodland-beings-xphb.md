...
In addition, you can take the [Disengage](rules/actions.md#Disengage) action as a [Bonus Action](rules/variant-rules/bonus-action-xphb.md) for the spell's duration.
