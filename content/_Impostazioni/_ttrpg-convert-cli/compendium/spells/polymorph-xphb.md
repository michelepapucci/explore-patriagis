...
The target gains a number of [Temporary Hit Points](rules/variant-rules/temporary-hit-points-xphb.md) equal to the [Hit Points](rules/variant-rules/hit-points-xphb.md) of the Beast form. The spell ends early on the target if it has no [Temporary Hit Points](rules/variant-rules/temporary-hit-points-xphb.md) left.
