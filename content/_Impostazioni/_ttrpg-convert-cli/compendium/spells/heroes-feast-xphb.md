...
A creature that partakes gains several benefits, which last for 24 hours. The creature has [Resistance](rules/variant-rules/resistance-xphb.md) to Poison damage, and it has [Immunity](rules/variant-rules/immunity-xphb.md) to the [Frightened](rules/conditions.md#Frightened) and [Poisoned](rules/conditions.md#Poisoned) conditions. Its [Hit Points](rules/variant-rules/hit-points-xphb.md) maximum also increases by `dice:2d10|noform|avg` (`2d10`), and it gains the same number of [Hit Points](rules/variant-rules/hit-points-xphb.md).
