...
When you move the sphere, you can direct it over barriers up to 5 feet tall and jump it across pits up to 10 feet wide. Flammable objects that aren't being worn or carried start [burning](compendium/traps-hazards/burning-xphb.md) if touched by the sphere, and it sheds [Bright Light](rules/variant-rules/bright-light-xphb.md) in a 20-foot radius and [Dim Light](rules/variant-rules/dim-light-xphb.md) for an additional 20 feet.
