...
You compel one creature you can see within range to die. If the target has 100 [Hit Points](rules/variant-rules/hit-points-xphb.md) or fewer, it dies. Otherwise, it takes `dice:12d12|noform|avg` (`12d12`) Psychic damage.
