...
You shoot a greenish ray at a creature within range. Make a ranged spell attack against the target. On a hit, the target takes `dice:2d8|noform|avg` (`2d8`) Poison damage and has the [Poisoned](rules/conditions.md#Poisoned) condition until the end of your next turn.
