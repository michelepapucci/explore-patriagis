...
A creature of your choice that you can see within range regains [Hit Points](rules/variant-rules/hit-points-xphb.md) equal to `dice:2d4|noform|avg` (`2d4`) plus your spellcasting ability modifier.
