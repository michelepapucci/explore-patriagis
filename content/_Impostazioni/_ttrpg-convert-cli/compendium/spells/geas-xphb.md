...
While [Charmed](rules/conditions.md#Charmed), the creature takes `dice:5d10|noform|avg` (`5d10`) Psychic damage if it acts in a manner directly counter to your command. It takes this damage no more than once each day.
