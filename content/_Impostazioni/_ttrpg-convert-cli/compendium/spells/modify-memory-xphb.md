...
A [Remove Curse](compendium/spells/remove-curse-xphb.md) or [Greater Restoration](compendium/spells/greater-restoration-xphb.md) spell cast on the target restores the creature's true memory.
