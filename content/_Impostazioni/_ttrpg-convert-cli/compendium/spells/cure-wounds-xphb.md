...
A creature you touch regains a number of [Hit Points](rules/variant-rules/hit-points-xphb.md) equal to `dice:2d8|noform|avg` (`2d8`) plus your spellcasting ability modifier.
