...
- **Grovel.** The target has the [Prone](rules/conditions.md#Prone) condition and then ends its turn.  
- **Halt.** On its turn, the target doesn't move and takes no action or [Bonus Action](rules/variant-rules/bonus-action-xphb.md).  
