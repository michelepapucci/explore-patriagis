...
You can also turn [Difficult Terrain](rules/variant-rules/difficult-terrain-xphb.md) caused by plant growth (such as thickets and undergrowth) into ordinary terrain that lasts for the duration. Or you can turn ordinary terrain where plants are present into [Difficult Terrain](rules/variant-rules/difficult-terrain-xphb.md) that lasts for the duration.
