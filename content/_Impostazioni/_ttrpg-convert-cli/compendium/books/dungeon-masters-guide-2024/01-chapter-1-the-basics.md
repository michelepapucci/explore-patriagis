...
![You don't need a magical g...](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/XDMG/000-00-001.magic-game-table.webp#center "You don't need a magical game table to play D&D, but wouldn't it be fun?")
...
Everyone needs some way to take notes. During every round of combat, someone needs to keep track of [Initiative](rules/variant-rules/initiative-xphb.md), [Hit Points](rules/variant-rules/hit-points-xphb.md), conditions, and other information. Players often like to take notes about what happens in the adventure, and at least one of them should record any clues and treasure the characters collect.
...
![What do you do when a die ...](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/XDMG/001-00-002.cocked-die-roll.webp#center "What do you do when a die lands cocked? See the end of this chapter for advice")
...
![Like Zuggtmoy, the Demon Q...](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/XDMG/002-00-003.zuggtmoy.webp#center "Like Zuggtmoy, the Demon Queen of Fungi, cultivates her fungal gardens, you can carefully cultivate a vibrantly growing campaign!")
...
- **Obstacles to Success.** A lock, a guard, or some other obstacle might hinder a character's ability to complete a task. In those cases, you typically call for a [D20 Test](rules/variant-rules/d20-test-xphb.md), usually an ability check. For example, a successful Dexterity ([Sleight of Hand](rules/skills.md#Sleight%20of%20Hand)) check might be needed to pick the lock, while a successful Charisma ([Persuasion](rules/skills.md#Persuasion)) check and some coins might be needed to bribe the guard. The ""Resolving Outcomes"" section in "chapter 2" gives more guidance on how to use [D20 Test](rules/variant-rules/d20-test-xphb.md) and other tools to determine the results of characters' actions.  
- **Roleplaying.** When the players interact with other creatures, roleplay those creatures based on whether they are [Friendly [Attitude]](rules/variant-rules/friendly-attitude-xphb.md), [Indifferent [Attitude]](rules/variant-rules/indifferent-attitude-xphb.md), or [Hostile [Attitude]](rules/variant-rules/hostile-attitude-xphb.md). Improvise based on what you know about the creatures, their knowledge, and their motivations. Then bring these creatures to life as you describe what happens. (See the ""Running Social Interaction"" section in "chapter 2" for more advice.)  
...
Try not to end a game session in the middle of an encounter. It's difficult to keep track of information such as [Initiative](rules/variant-rules/initiative-xphb.md) order and other round-by-round details between sessions. An exception to this guideline is when you purposely end a session with a cliffhanger, where the story pauses just as something monumental happens or some surprising turn of events occurs. A cliffhanger can keep players intrigued and excited until the next session.
...
![Sinister shapes lurk near ...](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/XDMG/003-00-004.cave-entrance.webp#center "Sinister shapes lurk near the cave entrance as the adventurers approach")
...
> [!note] 3
> 
> The DM rolls [Initiative](rules/variant-rules/initiative-xphb.md) just once for all six monsters and writes down that they'll go on Initiative count 17. The DM then goes around the table to get each player's Initiative roll. See the ""Running Combat"" section in "chapter 2" for advice about rolling and tracking Initiative.
^3
...
> [!note] 6
> 
> Asking for the spell's damage allows the DM to roll a saving throw for each monster and mark off the right amount of damage for that one. In this case, though, the monsters have [Vulnerability](rules/variant-rules/vulnerability-xphb.md) to Fire damage (because they're just dry shrubs) and so few [Hit Points](rules/variant-rules/hit-points-xphb.md) that they'll die no matter what they roll.
^6
...
![Conflicts between characte...](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/XDMG/005-00-006.character-conflict.webp#center "Conflicts between characters aren't always bad, but they can get in the way of the game")
...
- **Rules Aren't Physics.** The rules of the game are meant to provide a fun game experience, not to describe the laws of physics in the worlds of D&D, let alone the real world. Don't let players argue that a bucket brigade of ordinary people can accelerate a spear to light speed by all using the [Ready](rules/actions.md#Ready) action to pass the spear to the next person in line. The Ready action facilitates heroic action; it doesn't define the physical limitations of what can happen in a 6-second combat round.  
